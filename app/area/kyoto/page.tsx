...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】京都の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "京都で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、坪庭・町家の小さな庭の頼み方、苔を活かす庭とコケ対策の使い分けまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】京都の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "京都で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。坪庭・町家の小さな庭の手入れの頼み方や、苔を活かすか取り除くかの考え方など、京都で押さえたい注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、京都市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。狭い路地の奥など重機が入れない立地でも、木を切り分けて搬出する方法を含めて相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "路地の奥・狭い敷地の木の伐採を相談したい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。小さな庭でも季節ごとに手が入ることで景色が保たれるため、庭を「維持する」ことを重視する方に向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。京都市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、坪庭の広さや「苔は残したい」といった要望を写真とあわせて事前に伝えやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 庭の広さより「残したいもの」を先に整理する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、京都の小さな庭では「残したいもの」を先に決めておくことが大切です。苔・景石・下草・鉢など、作業中に踏まれたり動かされたりしては困るものを書き出し、対象の木の種類・高さ・本数とあわせてスマートフォンで撮影しておくと、電話やフォームでの見積もり精度が上がり、仕上がりのイメージ違いも防げます。",
  },
  {
  ...
  {
    t: "③ 車が入れるか・どこに停めるかを最初に伝える",
    b: "町家や路地奥の住宅では、作業車を家の前に着けられないことが珍しくありません。車が入れない場合は機材の搬入も枝の搬出も人力になり、作業時間や料金に影響します。見積もりの段階で「前面道路の幅」「車が入れるか」「近くに停められる場所があるか」を正直に伝えておくと、当日の追加費用や作業変更のリスクを減らせます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "坪庭だけの小さな庭でも手入れを頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。坪庭のモミジ1本だけ、玄関脇のマツ1本だけといった依頼でも相談できます。くらしのマーケットなら、庭の広さと写真を予約前にメッセージで伝えて、小さな庭の作業に慣れた出店者を口コミで選ぶこともできます。",
  },
  {
    q: "庭の苔を傷めないように剪定してもらえますか？",
    a: "依頼時に「苔は残したい」と明確に伝えることが大切です。苔を活かした庭では、脚立の置き方や剪定枝の落とし方、掃除の仕方によって苔が傷むことがあるため、見積もりの段階で苔の範囲を写真で共有し、養生や枝の回収方法を相談しておきましょう。くらしのマーケットのように予約前にメッセージでやり取りできるサービスなら、要望を細かく伝えたうえで依頼できます。",
  },
  {
    q: "逆に、庭に生えた苔を取り除きたい場合も頼めますか？",
    a: "相談できます。日当たりや水はけの関係で意図せず苔が広がってしまった場所は、単に剥がすだけでは再発しやすく、日照・風通し・排水の改善といった環境面の対策もあわせて考える必要があります。庭木の剪定で日当たりと風通しを改善することも一つの方法です。苔を活かす場合と取り除く場合の考え方は、当サイトの庭の苔対策の記事でも詳しく解説しています。",
  },
  {
    q: "車が入れない路地の奥にある家でも依頼できますか？",
    a: "多くの場合、依頼自体は可能ですが、見積もり時に必ず状況を伝えてください。作業車が近くに停められない場合、機材の搬入や枝の搬出が人力になり、作業時間・料金に影響することがあります。前面道路の幅、路地の長さ、近隣の駐車場の有無を写真とあわせて共有しておくと、業者側も正確な段取りと金額を出しやすくなります。",
  },
  {
    q: "京都で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）、24時間365日受付です。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "切った枝や落ち葉の処分もお願いできますか？",
...
export default function AreaKyotoPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】京都の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "京都で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "京都の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kyoto5",
      label: "1｜京都で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "京都の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#tsuboniwa", label: "2｜坪庭・町家の小さな庭は「1本単位」で頼みやすい" },
    { href: "#koke", label: "3｜苔は「活かす」か「対策する」かを最初に決める" },
    { href: "#roji", label: "4｜狭い路地・車が入れない立地は搬出と駐車の確認を" },
    { href: "#shobun", label: "5｜剪定枝・落ち葉の処分は総額とあわせて確認を" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜京都の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">京都の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「坪庭のモミジが伸びてきたけれど、狭くて自分では手が入れられない」「庭の苔を残したいのに、作業で踏み荒らされないか心配」——京都の庭の相談には、広さよりも「質」にまつわる悩みが目立ちます。町家の坪庭や玄関先の小さな植え込みは、面積こそ小さいものの、木1本・石1つ・苔一面で景色が決まる繊細な空間です。だからこそ、雑に刈り込まれてしまうと取り返しがつかず、業者選びと要望の伝え方が仕上がりを大きく左右します。
            </p>
            <p>
              本記事では、京都市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「坪庭・町家の小さな庭の頼み方」「苔を活かす庭とコケ対策の使い分け」「狭い路地での搬出・駐車の注意点」といった、京都ならではの依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kyoto5" num="1">京都で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            京都市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月12日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、京都での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜坪庭 */}
          <H2 id="tsuboniwa" num="2">坪庭・町家の小さな庭は「1本単位」で頼みやすい</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            町家の坪庭や玄関先の植え込みは、木の本数こそ少ないものの、<Hl>1本の枝ぶりがそのまま庭全体の景色になる</Hl>という意味で、広い庭以上に剪定の質が問われる空間です。刈り込みで形を整えるのか、枝を抜いて自然な樹形を活かすのかによって印象は大きく変わるため、依頼時には「どんな雰囲気に仕上げたいか」を写真や言葉で伝えることが大切です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            小さな庭の依頼で使いやすいのが、<Hl>庭木1本から頼める料金体系のサービス</Hl>です。剪定110番は剪定1本2,890円〜・現地調査無料で、坪庭の1本だけという依頼でも相談できます。くらしのマーケットなら、地域の出店者の施工例や口コミを見て「小さな庭の扱いに慣れていそうか」を自分の目で確かめてから予約できます。作業スペースが限られる坪庭では、脚立の置き場所や建具・塀の養生も含めて、事前に状況を共有しておくと安心です。
          </p>

          {/* 3｜苔 */}
          <H2 id="koke" num="3">苔は「活かす」か「対策する」かを最初に決める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            京都の庭と切っても切れないのが苔です。ここで大切なのは、<Hl>自分の庭の苔を「景色として活かしたい」のか「困っているので取り除きたい」のかを最初にはっきりさせる</Hl>ことです。同じ苔でも、この方針によって業者への頼み方は正反対になります。活かしたい場合は、剪定作業で苔を踏み荒らさないよう、養生の方法・枝の落とし方・掃除の仕方まで含めて見積もり時に相談しましょう。苔の範囲を写真で共有しておくと、作業する側も段取りを組みやすくなります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            一方、日当たりや水はけの悪さで意図せず苔が広がってしまった場所は、剥がすだけでは再発しやすく、<Hl>日照・風通し・排水といった環境の改善とセットで考える</Hl>必要があります。庭木が茂りすぎて日陰を作っているなら、剪定で光と風を入れることが苔対策にもなります。苔を活かす手入れと取り除く対策の考え方は、
            <Link href="/niwa-koke-taisaku/" className="text-[#2D7F3E] underline font-bold">
              庭の苔対策の記事
            </Link>
            で詳しく解説しているので、方針を決める際の参考にしてください。
          </p>

          {/* 4｜路地 */}
          <H2 id="roji" num="4">狭い路地・車が入れない立地は搬出と駐車の確認を</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            町家や路地奥の住宅で庭仕事を頼むとき、意外と見落とされがちなのが「車の問題」です。<Hl>作業車が家の前に着けられない場合、機材の搬入も剪定枝の搬出もすべて人力</Hl>になり、作業時間と手間が変わってきます。うなぎの寝床と呼ばれる細長い敷地では、庭が家の奥にあり、切った枝を建物の中や狭い通路を通して運び出すケースもあります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            こうした立地の依頼では、<Hl>前面道路の幅・路地の長さ・駐車できる場所の有無を見積もり時に必ず伝える</Hl>ことがトラブル防止の近道です。あわせて、建物や塀を傷つけないための養生についても確認しておきましょう。伐採110番は重機が入れない立地でも木を切り分けて搬出する方法を含めて相談でき、くらしのマーケットなら予約前のメッセージで搬出経路の写真を送って相談できます。状況を正確に伝えるほど、見積もりの精度は上がります。
          </p>

          {/* 5｜処分 */}
          <H2 id="shobun" num="5">剪定枝・落ち葉の処分は総額とあわせて確認を</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            小さな庭でも、剪定枝や落ち葉は積み重なるとかなりの量になります。家庭ごみとして出す場合は<Hl>長さ・束ね方・一度に出せる量など市区町村ごとのルール</Hl>を確認する必要があり、収集日との兼ね合いで庭に枝を置いておく期間が生じることもあります。路地奥の住宅では枝を収集場所まで運ぶ動線も限られるため、量が多いときは業者に処分まで任せるほうが現実的です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            業者に頼む場合は、<Hl>処分費・出張費を含めた総額</Hl>を見積もり時に確認しましょう。伐採110番は伐採後の木材処分まで一括対応をうたっています。処分費が料金に含まれるかはサービス・加盟店により異なるため、「この金額は処分込みか」というひと言の確認が、あとからの行き違いを防ぎます。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">京都の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            京都で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。坪庭の1本から頼むなら剪定110番、路地奥の木の伐採と処分なら伐採110番、雑草対策なら草刈り110番、小さな庭の景色を保つ定額管理ならsmileガーデン、施工例と口コミで自分の目で選びたいならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            京都の庭の依頼で大切なのは、面積ではなく「何を残し、どう仕上げたいか」を伝えることです。苔を活かすのか対策するのかの方針を先に決めること、路地・駐車といった立地の事情を見積もり時に正直に伝えること、処分費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwa-koke-taisaku/", label: "庭の苔対策の基本｜生える原因と除去・予防の方法" },
