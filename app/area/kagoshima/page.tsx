...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】鹿児島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "鹿児島で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、火山灰が積もった庭の手入れの一般的な考え方、成長の早い庭木と付き合う剪定の頻度まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】鹿児島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "鹿児島で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。火山灰が積もった庭まわりの手入れの一般的な考え方、温暖な気候でぐんぐん伸びる庭木・雑草との付き合い方、台風シーズン前の庭木対策も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、鹿児島市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。想定より大きく育ちすぎた木や、台風で傾いた木の整理も、伐採から抜根・処分まで一度に相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "台風で傾いた・折れた木の整理を頼みたい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。生育の早い庭木の手入れを年間サイクルにまとめて、伸びすぎる前に手が入る仕組みを作る使い方にも向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。鹿児島市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、灰が積もった庭まわりの掃除や高圧洗浄など、地域ならではの困りごとを扱う出店者を探す使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 「どのくらいのペースで伸びるか」も含めて状況を伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、生育の早い庭木は「前回切ってからどのくらいでこの状態になったか」が重要な情報になります。今の庭の写真とあわせて、前回手入れした時期を伝えると、単発で切るだけでなく、次はいつ頃手を入れるべきかという維持のペースまで含めた提案を受けやすくなります。",
  },
  {
  ...
  {
    t: "③ 台風シーズン前の依頼は時期に余裕を持つ",
    b: "台風の通り道になりやすい土地では、夏から秋にかけての庭木の枝抜きや危険木の整理は依頼が集中しやすい作業です。台風情報が出てから慌てて頼んでも、希望日に予約が取れないことがあります。「今年は台風が来る前に整えておきたい」と考えているなら、シーズン入り前の早い時期に見積もりだけでも済ませておくのがおすすめです。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "鹿児島で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。伸びるのが早くて毎年手に負えなくなる木を1本だけ整えたいという依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "火山灰が積もった庭の掃除も業者に頼めますか？",
    a: "庭木の手入れとは別の作業になりますが、庭まわりの掃除や高圧洗浄を扱う業者に相談できます。くらしのマーケットなら、掃除・洗浄系の出店者を口コミで比較し、予約前にメッセージで「庭やテラスに積もった灰の掃除をお願いしたい」と相談できます。回収した灰の出し方は自治体ごとにルールがあるため、お住まいの自治体の案内にあわせて処理しましょう。",
  },
  {
    q: "葉に灰が積もった庭木は、そのままにして大丈夫ですか？",
    a: "一般論として、葉に積もった灰は雨で流れることが多いものの、降灰が続いて厚く積もった場合は、日光を受ける葉の働きに影響するのではと気にされる方もいます。ホースの水で洗い流せる範囲なら掃除のついでに流しておくと安心です。木の元気がない・葉の変色が続くなど灰以外の要因が疑われる場合は、写真を撮って業者や園芸店に相談しましょう。",
  },
  {
    q: "成長の早い庭木は、年に何回くらい剪定が必要ですか？",
    a: "樹種と目標の大きさによりますが、温暖な地域では生育が旺盛になりやすく、樹種によっては年1回の剪定では追いつかないことがあります。「毎年強く切り戻す」より「年2回ほどの軽い剪定で形を保つ」ほうが木への負担も見た目も安定するとされます。適したペースは木ごとに違うため、現地を見た業者に維持サイクルを相談するのが確実です。",
  },
  {
    q: "台風の前に庭木のどんな対策をしておくべきですか？",
    a: "枝が混み合った木は風を強く受けるため、風の通り道を作る枝抜き剪定が基本の備えとされています。加えて、支柱のゆるみの点検、鉢植えや庭の物の片付けも大切です。傾いている木や枯れ枝のある木は倒木・落枝の危険があるため、シーズン前に業者に見てもらいましょう。詳しくは当サイトの台風対策の解説記事でまとめています。",
  },
  {
...
export default function AreaKagoshimaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】鹿児島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "鹿児島で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "鹿児島の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kagoshima5",
      label: "1｜鹿児島で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "鹿児島の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#kazanbai", label: "2｜火山灰が積もった庭は「灰の逃げ場」を考えて手入れする" },
    { href: "#seicho", label: "3｜成長の早い庭木は「切る量」より「切る頻度」で考える" },
    { href: "#taifu", label: "4｜台風シーズン前の枝抜きと危険木の点検が夏の備え" },
    { href: "#zasso", label: "5｜温暖な気候の雑草は「刈る」と「覆う」の組み合わせで抑える" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜鹿児島の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">鹿児島の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「灰が降った後の庭の掃除が毎回大変」「庭木の伸びるスピードが早すぎて、切っても切っても追いつかない」——鹿児島で庭業者を探す相談には、こうした「降灰後の庭まわりの手入れ」と「旺盛に育つ庭木・雑草の管理」の悩みがよく関わってきます。温暖な気候は庭の植物にとって恵まれた環境ですが、その分、手入れの間隔が短くなりがちで、放っておくとあっという間に庭が茂ってしまいます。
            </p>
            <p>
              本記事では、鹿児島市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「火山灰が積もった庭の手入れの一般的な考え方」「成長の早い庭木と付き合う剪定の頻度」「台風シーズン前の備え」「伸びの早い雑草の抑え方」といった、南国の庭ならではの依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kagoshima5" num="1">鹿児島で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            鹿児島市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月16日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月16日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、鹿児島での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜火山灰 */}
          <H2 id="kazanbai" num="2">火山灰が積もった庭は「灰の逃げ場」を考えて手入れする</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            降灰のある地域の庭では、テラスや飛び石、庭木の葉、雨どいなど、あらゆる場所に灰が積もります。一般的な考え方として大切なのは、<Hl>灰を「どこに集めて、どう出すか」という逃げ場を決めてから掃除を始める</Hl>ことです。やみくもに水で流すと、排水口や側溝に灰がたまって詰まりの原因になることがあります。乾いた灰はほうきで集めて回収し、回収した灰はお住まいの自治体が案内する方法（回収袋・指定の出し方など）に従って出しましょう。掃除の際は、灰を吸い込んだり目に入れたりしないよう、マスクなどで防護するのが基本です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭木の葉に積もった灰は雨で流れることも多いですが、気になる場合はホースの水でやさしく流せます。それよりも影響が出やすいのは、<Hl>砂利敷きの庭や地面の低い場所に灰がたまり続ける</Hl>ことです。砂利の隙間に灰と土がたまると雑草が根付きやすくなるため、降灰の多い庭では、砂利の目詰まりの掃除や敷き直しも定期的な手入れの一つになります。庭まわりの掃除や高圧洗浄をまとめて頼みたい場合は、くらしのマーケットで掃除・洗浄系の出店者に写真を送って相談する方法があります。庭全体の管理は、砂利敷きの考え方をまとめた
            <Link href="/jarishiki/" className="text-[#2D7F3E] underline">砂利敷きの解説記事</Link>
            も参考にしてください。
          </p>

          {/* 3｜成長の早い庭木 */}
          <H2 id="seicho" num="3">成長の早い庭木は「切る量」より「切る頻度」で考える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            温暖な気候では庭木の生育が旺盛になりやすく、暖地でよく育つ常緑の庭木や生垣は、<Hl>1回の剪定で強く切り詰めるより、間隔を詰めて軽く整えるほうが樹形も木の健康も安定する</Hl>と一般に言われています。「伸びきってから一気に切る」を繰り返すと、切り口から勢いの強い枝が吹いてかえって暴れやすくなり、木への負担も大きくなりがちです。年1回で追いつかない木は、年2回ほどの手入れサイクルに切り替えることを検討しましょう。剪定の時期の考え方は
            <Link href="/sentei-jiki/" className="text-[#2D7F3E] underline">剪定時期の解説記事</Link>
            でまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            手入れのサイクルを仕組みにするなら、smileガーデンの<Hl>定額制の年間管理プラン</Hl>のように、伸びすぎる前に定期的に手が入る形が向いています。スポットで頼む場合も、剪定110番は24時間365日受付・現地調査無料なので、「この木を年に何回、どのくらいの費用で維持できるか」という相談から始められます。すでに大きくなりすぎて手に負えない木は、無理に自分で切らず、
            <Link href="/takagi-sentei-kiken/" className="text-[#2D7F3E] underline">高い木の剪定の危険性の解説記事</Link>
            も参考に、高所作業の経験がある業者へ任せましょう。
          </p>

          {/* 4｜台風 */}
          <H2 id="taifu" num="4">台風シーズン前の枝抜きと危険木の点検が夏の備え</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            台風の影響を受けやすい土地では、庭木の備えはシーズン前に済ませておくのが基本です。枝が混み合った木は帆のように風を受けて、枝折れや倒木のリスクが高まります。<Hl>風の通り道を作る枝抜き剪定と、傾き・枯れ枝・ぐらつきのある木の点検</Hl>を、夏の本格化前に済ませておきましょう。事前と事後にやるべきことの全体像は
            <Link href="/taifu-niwaki-taisaku/" className="text-[#2D7F3E] underline">台風前後の庭木対策の解説記事</Link>
            で詳しくまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            すでに傾いている木や、幹に空洞・キノコが見られる木は、強風で倒れて建物や隣家に被害を及ぼす前に、伐採も含めた対処を検討したいところです。伐採110番なら<Hl>危険木の特殊伐採から処分まで一括</Hl>で相談でき、見積もりは無料です。台風シーズン前は同じ考えの依頼が集中しやすいため、剪定も伐採も、余裕のある時期に早めに相談しておくと希望日を確保しやすくなります。
          </p>

          {/* 5｜雑草 */}
          <H2 id="zasso" num="5">温暖な気候の雑草は「刈る」と「覆う」の組み合わせで抑える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            暖かい地域の雑草は生育期間が長く、伸びるスピードも速いため、<Hl>「気づいたときに刈る」だけの後追い管理では負担が増え続けます</Hl>。効果的なのは、刈った直後の地面を防草シートや砂利で覆い、雑草が生える面積そのものを減らしていく方法です。人がよく歩く場所・使っていない場所から順に覆っていくと、毎年の草取りの負担が目に見えて減っていきます。方法ごとの違いは
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            草刈り110番は1平米600円〜の草刈りに加えて防草シート施工にも対応しているため、「刈る」と「覆う」をまとめて相談できます。広い庭や空き地は<Hl>定期メンテナンスプラン</Hl>で管理を任せきりにする方法もあります。降灰対策で砂利敷きを検討している場合は、防草シートとの併用で雑草対策も兼ねられるため、見積もり時に庭全体の使い方を伝えて、覆い方の組み合わせを相談してみましょう。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">鹿児島の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            鹿児島で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。伸びの早い庭木を定期的に整えるなら1本から頼める剪定110番、台風前の危険木の整理なら処分まで一括の伐採110番、勢いの強い雑草の管理なら防草シートまで相談できる草刈り110番、手入れのサイクルをまるごと任せるならsmileガーデン、灰の掃除など庭まわりの困りごとを口コミで選んだ出店者に頼むならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            温暖な気候の庭は、植物の勢いに人の手入れが追いつくかどうかが勝負どころです。生育の早い木は切る頻度で管理すること、雑草は刈るだけでなく覆って面積を減らすこと、台風と降灰への備えは時期に余裕を持って進めること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
