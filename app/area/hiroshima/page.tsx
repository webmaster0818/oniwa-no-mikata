...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】広島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "広島で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、庭じまい・ローメンテナンス化の進め方、高齢の親の庭の管理を縮小する考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】広島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "広島で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。庭じまいの進め方や、芝生・植え込みを砂利・防草シートに置き換えるローメンテナンス化の考え方など、管理の負担を減らしたい方が押さえたい注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、広島市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。庭じまいで複数の木をまとめて整理したい場合も、伐採から抜根・処分まで一度に相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "庭じまいで複数の庭木をまとめて整理したい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        <Hl>防草シート施工や除草剤散布</Hl>
        もあわせて依頼でき、草取りの手間そのものを減らしたいローメンテナンス化の相談先としても使えます。
        <Hl>定期メンテナンスプラン</Hl>
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。木の本数を減らした後に残した庭木の手入れを定期的に任せる、といった使い方にも向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。広島市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、庭の写真を送って「どこまで減らすか」を相談しながら依頼内容を固めるといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 「減らす範囲」と「残すもの」を決めてから相談する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、広島で相談の多い庭じまい・ローメンテナンス化では、「どの木を残すか」「どの部分をやめるか」の方針をおおまかに決めてから相談すると話が早く進みます。思い入れのある木・シンボルツリーは残す、手のかかる生け垣や芝生はやめる、というように優先順位をメモし、スマートフォンで庭全体と気になる木を撮影しておくと、見積もりの精度が上がります。",
  },
  {
  ...
  {
    t: "③ 撤去した後の「仕上げ」まで見積もりに含める",
    b: "木を切る・芝をはがすといった撤去だけで終えると、むき出しの地面からすぐに雑草が生えてきます。ローメンテナンス化が目的なら、防草シートの施工や砂利敷きといった仕上げまで含めて見積もりを取り、「作業が終わった後の庭がどんな状態になるか」を確認しておきましょう。撤去と仕上げを別々の業者に頼むより、一括で相談したほうが段取りも費用の把握もしやすくなります。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "広島で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。庭じまいを進めて残した1本だけ整えたいという依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "高齢の親に代わって、子どもが庭の手入れを手配してもよいですか？",
    a: "問題ありません。見積もりの依頼や日程調整を離れて暮らす家族が行い、当日の立ち会いだけ親にお願いする、あるいは立ち会いも家族が行うといった形は一般的です。smileガーデンのように作業後に写真付きの報告書が受け取れるサービスなら、離れていても仕上がりを確認できます。誰が契約者になり、誰に連絡が入るのかだけは、依頼時にはっきり決めておきましょう。",
  },
  {
    q: "庭じまいでは、何から手を付ければよいですか？",
    a: "まず「残すもの」を決めることから始めるのがおすすめです。思い入れのある木や手のかからない木を残す候補にし、大きくなりすぎた木・手入れの負担が大きい生け垣や芝生を縮小・撤去の候補にします。方針が固まったら、伐採・抜根は伐採110番、雑草対策と防草シートは草刈り110番というように作業内容に合った業者へ見積もりを依頼しましょう。一度にすべてやる必要はなく、数年に分けて段階的に進める方法もあります。",
  },
  {
    q: "芝生をやめて砂利や防草シートにしたいのですが、頼めますか？",
    a: "頼めます。草刈り110番は草刈り・除草に加えて防草シート施工や除草剤散布にも対応しており、雑草が生えにくい状態への切り替えをまとめて相談できます。くらしのマーケットでも、防草シート施工や砂利敷きを扱う出店者を口コミ・料金で比較して選べます。シートの品質や施工の丁寧さで持ちが変わるため、見積もり時に使う資材と施工範囲を確認しておきましょう。",
  },
  {
    q: "木を全部切らずに、手入れが楽な庭にすることはできますか？",
    a: "できます。すべての木を伐採しなくても、本数を減らす・木の高さを下げる・手のかかる木だけ整理するといった方法で管理の負担は大きく減らせます。どの木を残すと管理が楽かは樹種や植えられている場所にもよるため、剪定110番のような見積もり無料のサービスで、現地調査の際にプロの意見を聞きながら決めるのがおすすめです。",
  },
  {
...
export default function AreaHiroshimaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】広島の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "広島で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "広島の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#hiroshima5",
      label: "1｜広島で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "広島の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#niwajimai", label: "2｜「庭じまい」は管理をあきらめることではなく整理すること" },
    { href: "#lowmainte", label: "3｜芝生・植え込みを砂利・防草シートに変えるローメンテナンス化" },
    { href: "#nokosu", label: "4｜残す木と手放す木を分ければ庭は続けられる" },
    { href: "#oyaniwa", label: "5｜離れて暮らす親の庭は「仕組み」で支える" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜広島の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">広島の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「実家の庭を手入れしてきた親が、高齢になって手が回らなくなった」「自分たち夫婦だけでは、この広さの庭はもう管理しきれない」——広島で庭業者を探す相談には、こうした「庭を維持する体力との折り合い」がよく含まれます。庭を今まで通りに保つことだけが正解ではありません。木の本数を減らす、芝生をやめて砂利や防草シートに切り替えるといった「庭じまい」「ローメンテナンス化」も、庭とのつき合いを続けるための立派な選択肢です。
            </p>
            <p>
              本記事では、広島市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「庭じまいの進め方」「芝生・植え込みを砂利・防草シートに置き換える考え方」「残す木と手放す木の分け方」といった、管理の負担を減らしたい方に向けた依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="hiroshima5" num="1">広島で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            広島市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月12日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、広島での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜庭じまい */}
          <H2 id="niwajimai" num="2">「庭じまい」は管理をあきらめることではなく整理すること</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭じまいというと「庭をなくしてしまう」ことのように聞こえますが、実際には<Hl>手入れの負担を今の暮らしに合った大きさまで縮小する作業</Hl>と考えるのが実態に近いところです。高齢になった親がこれまで通りに脚立へ上がるのは危険ですし、離れて暮らす子ども世帯が帰省のたびに草取りに追われるのも長続きしません。手のかかる木や芝生を整理して「無理なく維持できる庭」に作り替えることは、庭を荒れさせないための前向きな選択です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            進め方の基本は、一度に全部やろうとしないことです。まず<Hl>大きくなりすぎた木・毎年の手入れが特に大変な部分から順番に整理</Hl>し、庭の様子を見ながら次を決めていくと、費用も気持ちの負担も分散できます。複数の木をまとめて伐採・抜根する場合は、伐採110番のように<Hl>伐採から木材の処分まで一括で頼めるサービス</Hl>が向いています。見積もりは無料なので、「全部でいくらかかるのか」をまず把握することから始めましょう。
          </p>

          {/* 3｜ローメンテナンス化 */}
          <H2 id="lowmainte" num="3">芝生・植え込みを砂利・防草シートに変えるローメンテナンス化</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭の手入れの中でも、夏場の芝刈りと草取りは特に体力を消耗する作業です。管理を軽くしたい場合の定番が、<Hl>芝生や植え込みをやめて、防草シートの上に砂利を敷く</Hl>という置き換えです。雑草は土と日光があれば繰り返し生えてきますが、防草シートで日光を遮り、その上を砂利で覆えば、草取りの頻度を大きく減らせます。シートの敷き方や資材選びの考え方は
            <Link href="/bousou-sheet/" className="text-[#2D7F3E] underline">防草シートの解説記事</Link>
            で詳しくまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            注意したいのは、<Hl>撤去だけで終えると、むき出しの土からかえって雑草が勢いよく生えてくる</Hl>ことです。芝はがしや植え込みの撤去を頼むときは、その後の仕上げ（防草シート・砂利敷きなど）までセットで相談しましょう。草刈り110番は草刈り1平米600円〜に加えて防草シート施工・除草剤散布にも対応しており、「今の雑草を片付ける」と「生えにくくする」をまとめて依頼できます。くらしのマーケットなら、防草シートや砂利敷きを扱う地域の出店者を料金と口コミで比較して選べます。
          </p>

          {/* 4｜残す木と手放す木 */}
          <H2 id="nokosu" num="4">残す木と手放す木を分ければ庭は続けられる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭じまいで最も悩ましいのが、どの木を残すかという判断です。目安として、<Hl>思い入れのある木・暮らしの記憶と結びついた木は「残す候補」、大きくなりすぎて手に負えない木・毎年の剪定費がかさむ木は「手放す候補」</Hl>と分けて考えると整理しやすくなります。すべてを残そうとすると管理が破綻し、すべてを切ってしまうと殺風景になって後悔しがちです。数本のお気に入りだけを残し、その木にしっかり手をかける形が、長く続けやすい落としどころです。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            残す木も、放っておけばまた大きくなります。<Hl>高さを抑える剪定を定期的に入れて「管理できる大きさ」を保つ</Hl>ことが、庭じまい後の庭を維持するコツです。手のかからない庭木の考え方は
            <Link href="/teire-raku-niwaki/" className="text-[#2D7F3E] underline">手入れが楽な庭木の解説記事</Link>
            も参考にしてください。どの木を残すと楽になるかは樹種や植え場所にもよるため、剪定110番のような見積もり無料のサービスで現地調査を受け、プロの目で「残す・手放す」の相談をしながら決めるのがおすすめです。
          </p>

          {/* 5｜親の庭 */}
          <H2 id="oyaniwa" num="5">離れて暮らす親の庭は「仕組み」で支える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            親の家の庭が気になっていても、帰省のたびに自分で草を刈り、枝を切るのには限界があります。放置すれば雑草と枝は想像以上の速さで伸び、<Hl>荒れた庭は近隣への迷惑や、脚立作業をあきらめきれない親の転落事故のリスク</Hl>にもつながります。「気づいた人がその都度がんばる」体制から、「業者に定期的に入ってもらう仕組み」への切り替えを検討しましょう。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            smileガーデンの<Hl>定額制の年間管理プラン</Hl>は剪定・消毒・施肥をセットで任せられ、<Hl>作業後の写真付き報告書</Hl>で離れて暮らす家族も庭の状態を確認できます。雑草は草刈り110番の定期メンテナンスプランで刈り続けるか、前述の防草シート施工で「そもそも生えにくい庭」にしてしまう方法もあります。見積もりの手配や業者とのやり取りは子ども世帯が行い、当日の立ち会いだけ親にお願いする形にすれば、親の負担もほとんどありません。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">広島の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            広島で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。残した庭木の手入れなら庭木1本から頼める剪定110番、庭じまいで複数の木を整理するなら処分まで一括の伐採110番、雑草対策と防草シート施工なら草刈り110番、残した庭の定額管理ならsmileガーデン、砂利敷きなどの仕上げを口コミで比較しながら頼むならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            庭じまい・ローメンテナンス化は、庭をあきらめることではなく、今の暮らしに合った大きさに整理し直すことです。一度に全部やろうとせず優先順位をつけて進めること、撤去の後の仕上げまで含めて見積もりを取ること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/bousou-sheet/", label: "防草シートの選び方・敷き方" },
