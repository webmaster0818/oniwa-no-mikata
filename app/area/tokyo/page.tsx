...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】東京の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "東京で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・お庭マスター（剪定1本550円〜）の料金と特徴、住宅密集地・狭小地ならではの注意点、剪定枝の処分や駐車スペースの問題まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】東京の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "東京で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。住宅密集地の剪定や剪定枝の処分など、東京ならではの注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、東京都内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。東京都内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    slug: "oniwa-master",
    num: "1-5",
    ...
    intro: (
      <>
        お庭マスターは、関東・関西・中部エリアを中心に展開する職人品質のマッチング型サービスで、東京を含む関東は主力エリアです。
        <Hl>経験10年以上の職人が対応</Hl>
        し、中間マージンをカットすることで
...
const steps = [
  {
    t: "① 作業内容と庭の状況を整理する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのか、対象の木の種類・高さ・本数、庭のおおよその広さをメモしておくと、電話やフォームでの見積もり精度が上がります。スマートフォンで庭全体と対象の木の写真を撮っておくと、状況が伝わりやすくなります。",
  },
  {
  ...
  {
    t: "③ 搬入経路と駐車スペースの有無を伝える",
    b: "東京の住宅地では、作業車を停めるスペースがない、庭まで機材を運ぶ通路が狭いといった事情が料金や作業方法に影響することがあります。見積もりの段階で「駐車スペースの有無」「庭までの経路」を伝えておくと、当日になって追加費用や作業変更が発生するリスクを減らせます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "東京で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。お庭マスターも剪定1本550円〜と1本単位の料金体系です。ただし最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "東京の剪定料金の目安はいくらですか？",
    a: "当サイトが各社レビュー記事作成時に確認した掲載値では、剪定110番が1本2,890円〜（カシ2,300円・モミジ3,000円などの樹種別目安あり）、お庭マスターが1本550円〜、smileガーデンは剪定・伐採で3〜4万円台が相場とされています。樹種・高さ・本数・庭の状況で総額は大きく変わるため、無料見積もりで確認するのが確実です。",
  },
  {
    q: "切った枝や刈った草の処分もお願いできますか？",
    a: "伐採110番は伐採後の木材処分まで一括対応をうたっています。その他の業者でも処分まで含めて対応してもらえることが一般的ですが、処分費が料金に含まれるかどうかはサービス・加盟店により異なるため、見積もり時に必ず確認しましょう。自分で家庭ごみとして出す場合は、お住まいの自治体のルール（長さ・束ね方・量の制限など）の確認が必要です。",
  },
  {
    q: "見積もりだけ取って断ることもできますか？",
    a: "剪定110番は現地調査・見積もりが無料、お庭マスター・smileガーデンは見積もり・出張が無料、伐採110番も見積もり無料です。金額を見てから依頼するかどうか判断できます。くらしのマーケットは出店者ごとに料金が事前に明示されるため、予約前に比較検討が可能です。キャンセル条件の詳細は各サービスの規約をご確認ください。",
  },
];
...
export default function AreaTokyoPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】東京の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "東京で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "東京の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#tokyo5",
      label: "1｜東京で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "東京の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#kyosho", label: "2｜住宅密集地・狭小地の剪定で確認したいこと" },
    { href: "#shobun", label: "3｜剪定枝・刈り草の処分は自治体ルールの確認を" },
    { href: "#chusha", label: "4｜駐車スペースがない場合は見積もり時に相談" },
    { href: "#ringoku", label: "5｜隣家への枝の越境はトラブルになる前に" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜東京の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">東京の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「庭木が伸びすぎて隣の家にかかりそう」「夏の雑草が手に負えない」——東京で庭の手入れを業者に頼みたいとき、どこに依頼すればよいか迷う方は多いはずです。庭業者にはマッチング型・フランチャイズ型・直営型・プラットフォーム型といった形態の違いがあり、料金体系や得意分野もそれぞれ異なるため、比較せずに選ぶと「思ったより高くついた」という後悔につながりかねません。
            </p>
            <p>
              本記事では、東京都内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。住宅が密集する東京ならではの「狭小地の剪定」「剪定枝の処分」「駐車スペースの問題」といった注意点もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="tokyo5" num="1">東京で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            東京都内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          ...
          {/* 2｜狭小地 */}
          <H2 id="kyosho" num="2">住宅密集地・狭小地の剪定で確認したいこと</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            東京の住宅地は隣家との距離が近く、庭のスペースも限られていることが多いため、剪定・伐採の作業には郊外とは違った配慮が必要です。<Hl>脚立や高所作業の足場を置くスペースが確保できるか、切った枝が隣家側に落ちないように作業できるか</Hl>といった点は、料金や作業方法に直結します。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            特に大きくなった木の伐採では、重機やクレーンが進入できない立地の場合、木を少しずつ切り分けて下ろす手間のかかる作業になることがあります。伐採110番のように<Hl>特殊伐採や高所作業に対応しているサービス</Hl>であれば、そうした立地でも相談しやすいでしょう。見積もりの際には、庭の位置（建物の裏手かどうか）、隣家との距離、前面道路の広さを伝えておくと、金額のブレを減らせます。
          </p>

          {/* 3｜処分 */}
          <H2 id="shobun" num="3">剪定枝・刈り草の処分は自治体ルールの確認を</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            剪定や草刈りで意外と悩ましいのが、出てきた枝や草の処分です。家庭ごみとして出す場合、<Hl>枝の長さや束ね方、一度に出せる量などのルールは自治体ごとに定められており、東京23区でも区によって扱いが異なります</Hl>。量が多いと一度に出しきれず、庭の隅に枝の山が残ってしまうことも珍しくありません。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            業者に依頼する場合は、<Hl>処分費まで含めた総額</Hl>を見積もり時に確認するのがポイントです。伐採110番は伐採後の木材処分まで一括対応をうたっており、切った後の後片付けごと任せられます。自分で処分する前提で安く頼むのか、処分まで込みで頼むのかによって比較すべき金額が変わるため、見積もり時に「処分込みかどうか」を必ず確認しましょう。自分で出す場合は、お住まいの区・市のごみ出しルールを事前に確認してください。
          </p>

          {/* 4｜駐車 */}
          <H2 id="chusha" num="4">駐車スペースがない場合は見積もり時に相談</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭業者は作業車で機材を運んで来るため、<Hl>作業中に車を停める場所があるかどうか</Hl>は東京では無視できない問題です。敷地内や前面道路に停められない場合、近隣のコインパーキングを利用することになり、その費用の扱いはサービス・加盟店により異なります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            「駐車スペースがないことを当日伝えたら、追加の費用や作業時間の相談になった」という事態を避けるため、<Hl>見積もりの段階で駐車環境を正直に伝えておく</Hl>ことをおすすめします。あわせて、機材を庭まで運ぶ経路（玄関脇の通路の幅、家の中を通る必要の有無）も伝えておくと、当日の作業がスムーズです。
          </p>

          {/* 5｜隣家 */}
          <H2 id="ringoku" num="5">隣家への枝の越境はトラブルになる前に</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            住宅が密集する東京では、<Hl>伸びた枝が隣家の敷地にかかってしまうことが、ご近所トラブルの典型的な原因</Hl>になります。落ち葉が隣家の雨どいに溜まる、日当たりを妨げる、といった形で迷惑がかかっているケースもあります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            枝が越境してから対応を求められる前に、定期的な剪定で予防するのが結局は安上がりです。smileガーデンやダスキンのような<Hl>年間管理プランのあるサービス</Hl>なら、伸びすぎる前に手を入れてもらえます。また、作業当日は隣家側から枝を下ろす場面もあり得るため、業者と相談のうえ、必要に応じて事前にひと声かけておくと丁寧です。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">東京の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            東京で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。庭木1本からの剪定なら剪定110番やお庭マスター、大木の伐採と処分なら伐採110番、雑草対策なら草刈り110番、一年を通した定額管理ならsmileガーデン、というように、目的によって向いているサービスは変わります。口コミで地域の業者を選びたい方はくらしのマーケット、大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            どの業者を選ぶ場合も、処分費・出張費を含めた総額の見積もりを作業前に確認すること、狭小地や駐車環境などの事情を見積もり時に伝えることが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
