...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】大分の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "大分で剪定・伐採・草刈りを頼める庭業者を比較。伐採110番・剪定110番（1本2,890円〜）・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、駐車スペースのために庭を削るときの段取り、舗装後の排水と境界の確認まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】大分の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "大分で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。駐車スペースを広げるために庭を削るときの順番、残す部分と舗装する部分の分け方、舗装で変わる雨水の行き先、境界や塀まわりで担当が分かれる工事も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。駐車スペースを広げるために庭木を根元から片付けたい場合のように、
        <Hl>抜根まで必要になる作業</Hl>
        をひとつの相談にまとめられます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "庭木を抜いて地面を空けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、大分市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        <Hl>1平米600円〜の低価格</Hl>
        で、庭の雑草から空き地・駐車場の除草まで幅広く対応します。工事の前に敷地を片付けたいときや、
        <Hl>仕上げなかった部分の草を継続して抑えたい</Hl>
        ときに相談しやすいサービスです。刈った後の
        <Hl>防草シート施工や除草剤散布</Hl>
        、定期メンテナンスプランも用意されています。
      </>
    ),
    recommend: [
      "工事の前に敷地を片付けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。作り替えたあとに残した植栽を、毎年同じ基準で見てもらいたい場合に向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。大分市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、抜根まで対応できるかどうかを確かめてから予約するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 完成イメージと使い方を、写真とセットで伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、その庭を最終的にどう使いたいのかを伝えると、提案の質が変わります。車を何台停めたいのか、人はどこを歩くのか、残したい植栽はあるのかを整理し、今の庭の写真と一緒に伝えましょう。見積もりの精度も上がります。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・庭の状況で変わります。伐採した木材や抜いた根、刈り草の処分費、出張費まで含めた総額を必ず作業前に確認しましょう。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料、くらしのマーケットは出店者ごとに料金が事前明示されるため、金額を見てから判断できます。",
  },
  {
    t: "③ どこまでを誰に頼むのか、範囲の切り分けを確認する",
    b: "木を抜くところまでを庭業者に頼み、地面の仕上げは別の業者に頼むという分け方もあれば、まとめて対応できる場合もあります。工事の間に別々の業者が入ると、日程の調整や責任の所在が分かりにくくなることがあります。見積もりの段階で、どこまでが作業範囲なのかを文字で確認しておきましょう。",
  },
  {
    t: "④ 規模が大きいときほど複数社を比較する",
    b: "同じ庭でも、業者によって得意分野や料金体系は異なります。工事の規模が大きいほど金額の差も開きやすいため、2〜3社から見積もりを取り、総額・作業範囲・処分費の扱いを比較するのがおすすめです。金額や説明に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs = [
  {
    q: "大分で庭木を抜いて駐車スペースにしたいのですが、どこに頼めばよいですか？",
    a: "木を切る・抜くという作業は、伐採110番のような伐採・抜根に特化したサービスで相談できます。伐採後の木材処分まで一括対応をうたっており、見積もりは無料です。地面をコンクリートなどで仕上げる工事まで含めて頼みたい場合は、対応範囲を確認してください。工事の区分については当サイトの庭のリフォームと外構工事の違いの記事もご覧ください。",
  },
  {
    q: "切り株はそのままにしておいてもよいですか？",
    a: "地面を仕上げる予定があるなら、残さないほうが確実です。切り株を残すと、後から芽が出てくることや、地面の仕上げに支障が出ることがあります。抜根は木の大きさによって作業の規模が変わり、費用も変動します。当サイトの伐採と抜根の違い、切り株を放置するとどうなるかの記事に判断材料をまとめています。",
  },
  {
    q: "庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。抜くほどではないが車の出入りの邪魔になっている枝を整えたい、という頼み方もできます。最低価格ではなく出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "庭を舗装すると水はけは悪くなりますか？",
    a: "土の地面は雨水を吸い込みますが、舗装すると水は表面を流れるようになります。そのため、水をどこへ導くかを設計しておかないと、低い場所にたまったり隣地側へ流れたりする原因になります。工事の前に、勾配の取り方と水の行き先を説明してもらいましょう。当サイトの庭の水はけ改善の考え方の記事も参考になります。",
  },
  {
    q: "塀の一部を壊して出入り口を広げたいのですが、可能ですか？",
    a: "塀が自分の所有なのか、隣家のものか、共有なのかによって、手を入れてよい範囲が変わります。まずは境界標や過去の資料を確認し、隣家との関係が絡む場合は事前の話し合いが必要です。構造物の工事は外構・建築に近い領域になるため、対応できる業者かどうかも確認しましょう。当サイトの敷地境界と塀の解説記事をご覧ください。",
  },
  {
    q: "伐採した木や刈った草の処分もお願いできますか？",
...
export default function AreaOitaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】大分の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "大分で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "大分の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#oita5",
      label: "1｜大分で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "大分の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#sec2", label: "2｜駐車スペースを広げる工事は「木を抜く」ところから始まる" },
    { href: "#sec3", label: "3｜庭を削るなら「残す部分」と「仕上げる部分」を先に分ける" },
    { href: "#sec4", label: "4｜舗装すると雨水の行き先が変わる——排水の確認を忘れない" },
    { href: "#sec5", label: "5｜境界・塀・カーポートは、工事の担当が分かれることがある" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜大分の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">大分の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「車を停める場所を増やしたいが、庭の木をどうすればよいか分からない」「庭を削るとして、どこから頼めばよいのか」——大分で庭業者を探す相談には、車まわりの都合で庭を作り替えたいという動機が関わってくることがあります。日常的に車を使う暮らしでは、駐車スペースの不足がそのまま庭の見直しにつながります。
            </p>
            <p>
              本記事では、大分市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「庭を削る工事は木を抜くところから始まること」「残す部分と舗装する部分の分け方」「舗装したあとに変わる雨水の行き先」「境界や塀まわりで担当が分かれること」といった、庭を作り替えるときの依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="oita5" num="1">大分で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            大分市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月2日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月2日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、大分での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="sec2" num="2">駐車スペースを広げる工事は「木を抜く」ところから始まる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭の一部を駐車スペースにする場合、地面を仕上げる前に<Hl>そこに植わっている木をどうするかを決める必要があります</Hl>。単に地上部を切るだけでは、根が地面に残ります。切り株を残したままにすると、後から芽が出てくることや、地面の仕上げに支障が出ることがあります。切ることと抜くことの違いは<Link href="/bassai-bakkon-chigai/" className="text-[#2D7F3E] underline">伐採と抜根の違い</Link>、残した場合の影響は<Link href="/kirikabu-hochi/" className="text-[#2D7F3E] underline">切り株を放置するとどうなるか</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            <Hl>抜根は、木の大きさによって作業の規模が大きく変わる作業</Hl>です。根が深く広がっていれば掘る範囲が広がり、重機が必要になることもあります。伐採110番は伐採・抜根に特化したサービスで、大木・高木の特殊伐採や重機を使った作業に対応し、伐採後の木材処分まで一括で任せられることをうたっています。見積もりは無料なので、まず「この木を抜くとどうなるか」を数字で確認するところから始めるとよいでしょう。
          </p>

          <H2 id="sec3" num="3">庭を削るなら「残す部分」と「仕上げる部分」を先に分ける</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭全部を舗装してしまうと後から戻すのは難しく、<Hl>使わない部分まで一律に仕上げると費用も増えます</Hl>。車の出入りに必要な範囲、人が歩く範囲、植栽として残したい範囲を先に分けておくと、工事の規模と費用を抑えられます。図面が出てきたときに何を見るべきかは<Link href="/niwa-sekkeizu-mikata/" className="text-[#2D7F3E] underline">庭の設計図・平面図の読み方</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            仕上げ方にも選択肢があります。全面をコンクリートにする方法のほか、砂利で仕上げる方法、必要な部分だけ舗装する方法などがあり、費用と使い勝手が変わります。判断材料は<Link href="/niwa-doma-concrete/" className="text-[#2D7F3E] underline">庭をコンクリート・土間打ちにする判断</Link>と<Link href="/jarishiki/" className="text-[#2D7F3E] underline">庭の砂利敷きの基礎知識</Link>にまとめています。<Hl>残した部分の管理をどうするかも同時に決めておく</Hl>と、工事のあとに草だらけになるのを防げます。草を抑える方法は<Link href="/zasso-haenikui-niwa/" className="text-[#2D7F3E] underline">雑草が生えにくい庭のつくり方</Link>をご覧ください。
          </p>

          <H2 id="sec4" num="4">舗装すると雨水の行き先が変わる——排水の確認を忘れない</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            土の地面は雨水を吸い込みますが、<Hl>舗装すると水は表面を流れるようになります</Hl>。面積が広がるほど流れる水の量は増え、行き先が用意されていないと、低い場所にたまったり、隣地側へ流れたりする原因になります。工事の前に、水がどこへ向かうのかを確認しておきましょう。考え方は<Link href="/niwa-mizuhake/" className="text-[#2D7F3E] underline">庭の水はけ改善の考え方</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            あわせて確認したいのが屋外の桝の状態です。落ち葉や土がたまっていると、雨のときに流れが悪くなります。自分で見られる範囲は<Link href="/haisuimasu-tenken/" className="text-[#2D7F3E] underline">庭の排水桝の点検の基本</Link>をご覧ください。<Hl>工事のあとで水の流れが変わったことに気づくと、直すのに追加の費用がかかります</Hl>。見積もりの段階で、勾配をどう取るのか、水をどこへ導くのかを説明してもらい、納得してから進めてください。
          </p>

          <H2 id="sec5" num="5">境界・塀・カーポートは、工事の担当が分かれることがある</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭を作り替える工事は、<Hl>作業の種類によって相談先が分かれることがあります</Hl>。木を切る・抜く、草を刈るといった作業は庭業者の領域ですが、ブロック塀の設置や撤去、カーポートの設置といった構造物の工事は外構・建築の領域に近づきます。どの工事を誰に頼むべきかの切り分けは<Link href="/niwa-reform-gaiko-chigai/" className="text-[#2D7F3E] underline">庭のリフォームと外構工事の違い</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            境界に接する部分の工事には、とくに注意が必要です。<Hl>塀が自分のものか、隣家のものか、共有なのかによって、手を入れてよい範囲が変わります</Hl>。境界標の見方や確認の進め方は<Link href="/shikichi-kyokai-hei/" className="text-[#2D7F3E] underline">敷地境界と塀の基礎知識</Link>をご覧ください。工事の規模が大きくなるほど、複数社から見積もりを取って比べる価値が上がります。条件をそろえた比べ方は<Link href="/aimitsumori-torikata/" className="text-[#2D7F3E] underline">庭工事の相見積もりの取り方</Link>を参考にしてください。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">大分の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            大分で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。木を抜いて地面を空けるなら処分まで一括の伐採110番、残す木を整えるなら樹種別の目安がある剪定110番、工事の前後に草を片付けるなら面積単価が分かりやすい草刈り110番、残した庭を年間で見てもらうならsmileガーデン、作業単位で口コミと料金を見比べるならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            庭を削る工事は、木の処理から始まり、地面の仕上げ、排水、境界まわりへと話が広がります。残す部分と仕上げる部分を先に分けること、舗装で変わる水の行き先を工事前に確認すること、構造物にかかわる部分は担当の切り分けを確かめること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwa-doma-concrete/", label: "庭をコンクリート・土間打ちにする判断" },
                { href: "/niwa-reform-gaiko-chigai/", label: "庭のリフォームと外構工事の違い" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
