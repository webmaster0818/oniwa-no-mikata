...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】横浜の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "横浜で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・お庭マスター（剪定1本550円〜）の料金と特徴、坂や傾斜地・造成地の庭ならではの注意点、搬出経路と駐車、斜面の草刈りまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】横浜の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "横浜で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。坂・傾斜地の庭や搬出経路・駐車の問題など、横浜の住宅事情に合わせた注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、横浜市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。重機が入りにくい傾斜地や、擁壁の上の庭のような立地でも、木を切り分けて下ろす方法を含めて相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        を使えば夏場に伸び続ける雑草の管理を任せきりにできます。足場の悪い斜面の草刈りを自分で続けるのが不安になってきた方にも、業者への切り替えの選択肢になります。
      </>
    ),
    recommend: [
      "庭や空き地の雑草を低価格で片付けたい人",
      "斜面や法面の草刈りを自分でやるのが不安な人",
    ...
    memo:
      "1平米600円〜の料金と防草シート施工・除草剤散布・定期メンテナンスプランの提供を当サイトのレビュー記事作成時に確認しています。機械作業が中心のため狭い場所は苦手な場合があり、夏場の繁忙期は混み合います。斜面など作業条件が悪い場所は総額が変わりやすいため、見積もりで確認しましょう。",
  },
  {
    slug: "smile-garden",
    num: "1-4",
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。横浜市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    slug: "oniwa-master",
    num: "1-5",
    ...
    intro: (
      <>
        お庭マスターは、関東・関西・中部エリアを中心に展開する職人品質のマッチング型サービスで、横浜を含む関東は主力エリアです。
        <Hl>経験10年以上の職人が対応</Hl>
        し、中間マージンをカットすることで
...
const compareRows: {
  ...
  },
  {
    ...
    point: "経験10年以上の職人・施工後の保証あり（関東エリア中心・横浜対応）",
  },
  {
...
const steps = [
  {
    t: "① 作業内容と庭の状況を整理する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのか、対象の木の種類・高さ・本数、庭のおおよその広さをメモしておくと、電話やフォームでの見積もり精度が上がります。横浜では庭が斜面や擁壁の上にあるケースも多いため、スマートフォンで庭全体・対象の木・玄関から庭までの経路（階段や坂）を撮影しておくと、状況が正確に伝わります。",
  },
  {
  ...
  {
    t: "③ 搬出経路・駐車環境・傾斜の有無を伝える",
    b: "横浜の住宅地では、坂の途中で作業車を停めにくい、庭まで階段しかなく機材や枝を人力で運ぶ必要がある、といった事情が料金や作業方法に影響することがあります。見積もりの段階で「駐車スペースの有無」「庭までの経路（階段・坂・通路の幅）」「庭の傾斜」を伝えておくと、当日になって追加費用や作業変更が発生するリスクを減らせます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "横浜で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。お庭マスターも剪定1本550円〜と1本単位の料金体系で、横浜を含む関東は主力エリアです。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "坂の上や傾斜地の庭でも作業してもらえますか？",
    a: "多くの場合相談できますが、見積もり時に立地条件を必ず伝えましょう。作業車を停める場所から庭までの距離や高低差、階段の有無は、作業時間や枝の搬出方法に影響し、料金が変わる要因になります。写真を撮って共有すると話が早く、現地調査のある剪定110番などなら、見積もり段階で作業方法まで確認できます。",
  },
  {
    q: "斜面の草刈りも業者に頼めますか？",
    a: "頼めます。草刈り110番は庭の雑草から空き地の除草まで対応しており、1平米600円〜が目安です。ただし機械作業が中心のため、急な斜面や狭い法面は作業条件により対応方法・金額が変わることがあります。面積と傾斜の状況を伝えて見積もりで確認しましょう。刈った後に防草シートを施工して、そもそも草が生えにくくする相談もできます。",
  },
  {
...
export default function AreaYokohamaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】横浜の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "横浜で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "横浜の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#yokohama5",
      label: "1｜横浜で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "横浜の庭業者を一覧表で徹底比較" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">横浜の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「坂の上の家で、庭の枝や刈った草を運び出すだけでひと苦労」「斜面の草刈りが年々つらくなってきた」——横浜で庭の手入れを業者に頼みたいとき、こうした立地ならではの悩みを抱えている方は少なくありません。横浜には坂や傾斜地に造成された住宅地が多く、庭が擁壁の上にある、道路から玄関まで階段が続く、といった家も珍しくありません。平坦な庭と同じ感覚で依頼すると、搬出や駐車の問題が見積もりの段階で見落とされ、当日の追加相談につながることがあります。
            </p>
            <p>
              本記事では、横浜市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「坂・傾斜地・造成地の庭の注意点」「搬出経路と駐車の伝え方」「斜面の草刈りを業者に切り替える判断」といった、横浜で特に確認しておきたいポイントもまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="yokohama5" num="1">横浜で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            横浜市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          ...
          {/* 2｜傾斜地 */}
          <H2 id="keisha" num="2">坂・傾斜地・造成地の庭で確認したいこと</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            横浜の住宅地には、傾斜地を造成して作られた区画が多く、庭が擁壁の上や斜面に面しているケースがよくあります。こうした立地の剪定・伐採では、<Hl>足場が水平に取れるか、高低差のある場所で安全に作業できるか</Hl>が平坦地とは違うポイントになり、作業方法や料金に影響します。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            特に擁壁ぎわや斜面に立つ木は、倒す方向やロープでの吊り下ろしなど、安全確保のための段取りが増えるため、<Hl>高所作業や特殊伐採に対応しているサービス</Hl>に相談するのが安心です。伐採110番は大木・高木・危険木の特殊伐採に対応しており、重機が入れない立地でも木を切り分けて下ろす方法を含めて相談できます。見積もりの際には、庭の高低差、擁壁の有無、道路からのアクセスを具体的に伝えると、金額のブレを減らせます。
          </p>

          {/* 3｜搬出・駐車 */}
          <H2 id="hanshutsu" num="3">搬出経路と駐車環境は見積もり時に必ず伝える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            坂の多い横浜で見積もりの精度を左右するのが、<Hl>「切った枝をどう運び出すか」と「作業車をどこに停めるか」</Hl>です。庭までの経路が階段のみの場合、機材の搬入も枝の搬出も人力になり、作業時間と手間が増えます。また、坂の途中の狭い道路では作業車を長時間停めにくく、近隣のコインパーキングを利用する場合の費用の扱いはサービス・加盟店により異なります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            「当日になって、枝の運び出しに時間がかかると追加の相談をされた」という事態を避けるには、<Hl>見積もりの段階で搬出経路と駐車環境を正直に伝えておく</Hl>ことがいちばんの対策です。道路から玄関・庭までの階段の様子、通路の幅、駐車スペースの有無をスマートフォンで撮影して共有すれば、業者側も作業の段取りと金額を正確に出しやすくなります。
          </p>

          {/* 4｜斜面の草刈り */}
          <H2 id="shamen" num="4">斜面の草刈りは無理をせず業者への切り替えを</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            傾斜地の庭や敷地まわりの法面の草刈りは、平地に比べて足場が不安定で、<Hl>刈払機を使った自力作業では転倒・滑落のリスク</Hl>が伴います。若いうちは何とかなっていた斜面の草刈りが、年齢とともに負担になってきたという声は横浜のような坂の多い街では特に切実です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">横浜の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            横浜で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。庭木1本からの剪定なら剪定110番やお庭マスター、傾斜地の大木の伐採と処分なら伐採110番、斜面を含む雑草対策なら草刈り110番、一年を通した定額管理ならsmileガーデン、というように、目的によって向いているサービスは変わります。口コミで地域の業者を選びたい方はくらしのマーケット、大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            どの業者を選ぶ場合も、処分費・出張費を含めた総額の見積もりを作業前に確認すること、そして坂・階段・傾斜・駐車環境といった横浜ならではの立地条件を見積もり時に伝えることが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
