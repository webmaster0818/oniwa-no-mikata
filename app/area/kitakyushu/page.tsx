...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】北九州の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "北九州で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、切り株・放置庭木の整理の進め方、空き家の庭の定期管理の考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】北九州の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "北九州で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。切り株を残すか抜くかの考え方や、放置庭木の整理の優先順位、空き家の庭を定期管理で維持する方法など、実家・空き家の庭で押さえたい注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、北九州市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。伐採で残った切り株の抜根だけを後から相談することもでき、放置庭木の整理の相談先として使いやすいサービスです。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "庭に残ったままの切り株を抜根して片付けたい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        を使えば、住む人のいない家の庭の雑草管理を任せきりにできます。
      </>
    ),
    recommend: [
      "庭や空き地の雑草を低価格で片付けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。空き家や離れて暮らす実家の庭でも、作業後の
        <Hl>写真付きの作業報告書</Hl>
        で遠方から庭の状態を確認できるため、現地に行けない家の管理に使いやすいサービスです。見積もり・出張は無料です。
      </>
    ),
    recommend: [
      "一年を通して庭の手入れを定額で任せたい人",
      "空き家・実家の庭の管理を遠方から任せたい人",
      "剪定・消毒・施肥をセットでまとめたい人",
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。北九州市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、荒れた庭の写真を送って作業範囲を相談しながら依頼内容を固めるといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 「今回どこまで片付けるか」の範囲を決めてから相談する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、放置していた庭の整理では「今回は危険な木と雑草だけ」「切り株の抜根は次回」というように、片付ける範囲をおおまかに決めてから相談すると見積もりを比較しやすくなります。対象の木の種類・高さ・本数、庭のおおよその広さをメモし、スマートフォンで庭全体と気になる木・切り株を撮影しておくと、状況が正確に伝わります。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・庭の状況で変わります。長く放置した庭は刈り草・伐採木の量が多くなりがちなので、処分費・出張費まで含めた総額を必ず作業前に確認しましょう。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料、くらしのマーケットは出店者ごとに料金が事前明示されるため、金額を見てから判断できます。",
  },
  {
    t: "③ 空き家の作業は「立ち会い・鍵・連絡方法」を先に決める",
    b: "住んでいない家の庭の作業では、当日の立ち会いをどうするか、敷地への入り方、作業前後の連絡方法を事前に決めておく必要があります。遠方に住んでいて立ち会えない場合は、作業前後の写真報告があるか、追加作業が見つかったときの連絡・承認の流れはどうなるかを見積もり時に確認しておくと、行き違いを防げます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "北九州で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。実家の庭の1本だけ整えたいという依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "庭に残ったままの切り株だけを処分してもらうことはできますか？",
    a: "できます。切り株の抜根は伐採110番のような伐採・抜根専門サービスに相談できます。抜根は根の張り方や切り株の大きさ、周囲の配管・構造物の状況で作業量が変わるため、現地調査で金額を確定するのが一般的です。切り株の位置と大きさが分かる写真を用意して、見積もりを依頼しましょう。",
  },
  {
    q: "切り株を放置すると、何か問題がありますか？",
    a: "残しておくと、シロアリやハチなどの虫の住み処になったり、切り株から新しい芽が伸びて再び茂ったりすることがあるとされています。また、庭の中でつまずきの原因になり、その場所を駐車場や花壇に作り替える際の障害にもなります。急いで抜く必要があるとは限りませんが、庭の使い道が決まっているなら早めの抜根がおすすめです。伐採だけで済ませるか抜根までやるかは、費用と用途をあわせて判断しましょう。",
  },
  {
    q: "実家が空き家になりました。庭はどのくらいの頻度で手入れすればよいですか？",
    a: "庭の状態や季節によりますが、雑草が勢いよく伸びる春から夏は放置するとひと夏で藪のようになるため、この時期を中心に手が入る計画にするのが基本です。草刈り110番の定期メンテナンスプランやsmileガーデンの年間管理プランを使えば、訪問のたびに依頼し直す手間なく庭を維持できます。防草シート施工で雑草の伸び自体を抑えて、手入れの頻度を減らす方法もあります。",
  },
  {
    q: "何年も放置した庭なので、費用がどれくらいかかるか不安です。",
    a: "放置期間が長い庭は、草の丈・木の大きさ・処分する量に応じて費用も作業時間も増えますが、だからこそ先に総額を確かめる価値があります。剪定110番・伐採110番は現地調査・見積もりが無料なので、金額を見てから依頼するかどうか判断できます。予算が限られる場合は、危険な木の処理や道路側の枝など優先度の高い作業から段階的に進める方法を見積もり時に相談してみましょう。",
  },
  {
...
export default function AreaKitakyushuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】北九州の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "北九州で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "北九州の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kitakyushu5",
      label: "1｜北九州で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "北九州の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#kirikabu", label: "2｜切り株は残す？抜く？——伐採と抜根の違いから考える" },
    { href: "#yusen", label: "3｜放置庭木の整理は「危険な木」から優先順位をつける" },
    { href: "#akiya", label: "4｜空き家の庭は「帰省のたび」から「仕組みで回す」へ" },
    { href: "#shobun", label: "5｜量が多い片付けほど処分込みの総額を先に固める" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜北九州の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">北九州の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「木を切ったはいいが、切り株が庭に残ったままになっている」「親が住まなくなった実家の庭が、帰るたびに荒れていく」——北九州で庭業者を探す相談には、こうした「手つかずのまま時間がたってしまった庭」の悩みがよく含まれます。しばらく放置した庭は、どこから手を付ければよいか分からず、腰が重くなりがちです。しかし、切り株や伸び放題の庭木は、虫の住み処や倒木・落枝のリスクとして静かに育っていきます。
            </p>
            <p>
              本記事では、北九州市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「切り株を残すか抜くかの考え方」「放置庭木を整理する優先順位」「空き家の庭を定期管理で維持する方法」といった、手つかずの庭を立て直すための依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kitakyushu5" num="1">北九州で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            北九州市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月12日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、北九州での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜切り株 */}
          <H2 id="kirikabu" num="2">切り株は残す？抜く？——伐採と抜根の違いから考える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            木を処分するとき、地上部を切り倒す「伐採」と、根や切り株ごと取り除く「抜根」は別の作業です。<Hl>伐採だけで終えると切り株が庭に残り、抜根まで行えば地面を平らに使えるようになります</Hl>。抜根は根の張り方や周囲の配管・構造物の状況によって作業量が大きく変わるため、費用も伐採とは別に見積もられるのが一般的です。両者の違いと使い分けの考え方は
            <Link href="/bassai-bakkon-chigai/" className="text-[#2D7F3E] underline">伐採と抜根の違いの解説記事</Link>
            で詳しくまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            切り株を残したままにすると、<Hl>シロアリやハチなどの虫の住み処になったり、切り株から芽が伸びて再び茂ったりする</Hl>ことがあるとされています。その場所を駐車場・物置・花壇などに作り替える予定があるなら、抜根まで済ませておくのが結局は近道です。伐採110番は伐採・抜根の専門サービスで、過去に切ったまま残っている切り株の抜根だけでも相談できます。見積もりは無料なので、「抜くといくらか」をまず確認してから判断しましょう。
          </p>

          {/* 3｜優先順位 */}
          <H2 id="yusen" num="3">放置庭木の整理は「危険な木」から優先順位をつける</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            数年放置した庭を前にすると、つい「全部きれいにしないと」と考えて費用の大きさにひるんでしまいますが、一度に全部やる必要はありません。優先すべきは危険の芽です。<Hl>傾いてきた木、幹に空洞やキノコが見える弱った木、道路や隣家に張り出した枝</Hl>は、放置すると倒木・落枝で第三者に被害を及ぼしかねず、所有者として真っ先に対処したい対象です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            次に、家の壁や屋根に触れている枝、風通しを悪くして虫がわきやすくなっている茂みを整理し、見た目を整える剪定は最後で構いません。<Hl>「危険の処理→暮らしへの影響→美観」の順に段階を分ければ、1回あたりの費用を抑えながら確実に庭を立て直せます</Hl>。大きくなりすぎた木や危険木の処理は伐採110番のような専門サービスに、残す木の手入れは剪定110番に、というように作業内容ごとに相談先を分ける方法もあります。どちらも見積もり無料なので、優先順位ごとの金額を確認しながら計画を立てましょう。
          </p>

          {/* 4｜空き家の庭 */}
          <H2 id="akiya" num="4">空き家の庭は「帰省のたび」から「仕組みで回す」へ</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            親が施設に入った、相続したが住む予定がない——住む人のいなくなった家の庭は、手入れの担い手も同時にいなくなります。帰省のたびに草を刈る方式は、暑い時期ほど作業がきつく、回数を重ねるうちに息切れしがちです。放置された庭は<Hl>雑草や枝の越境で近隣の迷惑になるだけでなく、家が管理されていない印象を与えて防犯面の不安にもつながります</Hl>。空き家の庭の管理の考え方は
            <Link href="/akiya-niwa-kanri/" className="text-[#2D7F3E] underline">空き家の庭管理の解説記事</Link>
            で詳しく解説しています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            現実的なのは、業者に定期的に入ってもらう仕組みへの切り替えです。草刈り110番の<Hl>定期メンテナンスプラン</Hl>なら雑草が藪になる前に刈り続けられ、防草シート施工で「そもそも生えにくい状態」にして手入れの頻度自体を減らす方法もあります。庭木も含めて任せるなら、smileガーデンの年間管理プランは<Hl>作業後の写真付き報告書</Hl>で遠方からでも庭の状態を確認できます。立ち会えない場合の連絡方法や敷地への入り方は、見積もり時に決めておきましょう。
          </p>

          {/* 5｜処分 */}
          <H2 id="shobun" num="5">量が多い片付けほど処分込みの総額を先に固める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            放置した庭の整理では、刈り草・剪定枝・伐採した幹・抜いた切り株と、大量の植物ごみが一度に発生します。家庭ごみとして出すには<Hl>長さ・束ね方・一度に出せる量など市区町村ごとのルール</Hl>に従う必要があり、数年分伸びた庭の量を自分で出しきるのは現実的ではないことも多いものです。業者に頼む最大の利点の一つは、この処分まで一括で任せられることにあります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            ただし、<Hl>処分費が作業料金に含まれるかどうかはサービス・加盟店により異なります</Hl>。伐採110番は伐採後の木材処分までの一括対応をうたっていますが、どのサービスでも「処分込みの総額」を見積もりの段階で確認するのが鉄則です。くらしのマーケットなら料金が出店者ごとに事前明示され、予約前にメッセージで庭の写真を送って作業範囲と処分の扱いを確かめられます。量の多い片付けほど、複数社の総額を並べて比較する価値があります。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">北九州の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            北九州で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。切り株の抜根や放置庭木の伐採・処分なら伐採110番、残す木の手入れなら庭木1本から頼める剪定110番、空き家の雑草対策と防草シート施工なら草刈り110番、遠方からの定額管理ならsmileガーデン、荒れた庭の写真を送って相談しながら選びたいならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            手つかずのまま時間がたった庭は、「全部一度に」ではなく「危険な木から段階的に」が立て直しの基本です。切り株は庭の使い道が決まっているなら抜根まで、空き家の庭は定期管理の仕組みで、処分費を含めた総額は作業前に確認する——この3点を押さえれば、荒れた庭でも落ち着いて片付けられます。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
