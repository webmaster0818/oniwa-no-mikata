...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】大津の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "大津で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・草刈り110番（1平米600円〜）・伐採110番・smileガーデン・くらしのマーケットの料金と特徴、水辺に近い庭の湿気と風通し、水がたまる物を減らす虫対策、木製デッキ・フェンスの点検、池・水鉢の扱いまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】大津の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "大津で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。水辺に近い庭で湿気がこもる場所の減らし方、水がたまる物を減らす虫との付き合い方、湿気で傷みが早いウッドデッキ・木製フェンスの点検、池・水鉢のある庭をどうするかの判断も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、大津市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        ため、湿気で草がよく伸びる裏手や、デッキのまわりなど、片付けたい範囲を決めて頼みやすいサービスです。刈った後の
        <Hl>防草シート施工や除草剤散布</Hl>
        や、定期メンテナンスプランも用意されています。
      </>
    ),
    recommend: [
      "湿気で草が伸びやすい裏手や外周を片付けたい人",
      "範囲を決めて費用の見当をつけたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。家との間に湿気を閉じ込めている大きな木や、根元が傷んで倒れそうな木の整理もまとめて相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "家との間に湿気を閉じ込めている大きな木を整理したい人",
      "根元が傷んだ木を根元から処分したい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。湿気の多い時期の病害虫の確認まで含めて毎年の決まりごとにしたい庭では、回数と時期を決めて任せる形が向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
        が受け取れます。見積もり・出張は無料です。
      </>
    ),
    recommend: [
      "剪定と病害虫の確認を毎年セットで任せたい人",
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。大津市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、デッキ下や池まわりの作業を含められるかを聞いてから予約するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 湿気が気になる場所を、地面と木部が写る写真で伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、どこに湿気がこもっているのかを具体的に伝えましょう。株元や地面、デッキやフェンスの木部が写る写真があると、風通しをどう作るか、どこまでを庭業者の作業範囲にするかの相談がしやすくなります。雨上がりに撮った写真は、水がたまる場所を伝えるのに役立ちます。見積もりの精度も上がります。",
  },
  {
  ...
  {
    t: "③ 庭業者の範囲と、設備・工事の範囲を切り分ける",
    b: "水辺に近い庭では、植栽の手入れと、排水や設備にかかわる作業が同時に話題になりがちです。排水桝の掃除や落ち葉の除去は庭業者に相談できますが、給排水の配管にかかわる工事は指定工事事業者、屋外の電源工事は電気工事士、擁壁や護岸にかかわる補修は土木建築の専門業者の範囲です。最初に切り分けておくと、話が二度手間になりません。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "大津で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。家との間に湿気を閉じ込めている木だけ枝を透かしたい、といった依頼もできます。樹種や高さによって手間が変わるため、最低価格ではなく出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "湖に近いせいか、庭の湿気がなかなか抜けません。何から手をつければよいですか？",
    a: "まずは、庭の中で空気が動かない場所を探すことから始めるのがおすすめです。家と塀の間、密に茂った植え込みの内側、デッキの下などは湿気がこもりやすい場所です。枝を透かす、低木の厚みを減らす、地面に置きっぱなしの物をどかす、といった風通しを作る作業から始めると、苔やカビの出方が変わってきます。地面の水はけそのものが悪い場合は、当サイトの水はけ改善の記事も参考にしてください。",
  },
  {
    q: "水辺の虫が多くて庭に出るのがおっくうです。庭業者に頼めることはありますか？",
    a: "庭でできる基本は、水がたまる物を減らすことと、虫が隠れやすい茂みを整理することです。植木鉢の受け皿、バケツ、雨水タンクのふた、詰まった排水桝など、水がたまったままになる物を見直しましょう。庭木の病害虫についての消毒は庭業者に相談できますが、使う薬剤は製品ラベルの記載に従うのが原則です。家の中に入ってくる虫や、蜂の巣のような危険を伴うものは、状況に応じて専門の業者への相談になります。",
  },
  {
    q: "ウッドデッキの下の草と湿気が気になります。一緒に頼めますか？",
    a: "デッキまわりの草刈りや、デッキ下に手が届く範囲の片付けは、多くの庭業者が相談に応じます。ただし、デッキ本体の傷みの補修や交換は庭業者の範囲外になることが多く、施工した業者や外構の業者への相談になります。デッキ下の湿気対策として砂利や防草シートを敷く作業は、庭業者に相談できる範囲です。当サイトのウッドデッキ周りの手入れの記事に考え方をまとめています。",
  },
  {
    q: "使わなくなった池を埋めたいのですが、庭業者に頼めますか？",
    a: "池を埋める作業そのものは、造園業者や外構業者に相談できることが一般的です。ただし、池に給水や排水の配管がつながっている場合、その処理は指定工事事業者の範囲になります。埋め戻したあとの地面をどう仕上げるかまで決めてから相談すると、見積もりの比較がしやすくなります。当サイトの井戸・池のある庭の管理の記事に、使わなくなったときの扱いの考え方をまとめています。",
  },
  {
...
export default function AreaOtsuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】大津の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "大津で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "大津の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#otsu5",
      label: "1｜大津で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "大津の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#sec2", label: "2｜水辺に近い庭は「湿気がこもる場所」を減らすことから始める" },
    { href: "#sec3", label: "3｜水がたまる物を減らすことが、水辺の虫と付き合う基本" },
    { href: "#sec4", label: "4｜ウッドデッキ・木製フェンスは湿気で傷みが早い——点検の目安" },
    { href: "#sec5", label: "5｜池・水鉢のある庭は「水を動かす」か「やめる」かを決める" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜大津の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">大津の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「庭の湿気がなかなか抜けず、苔やカビが広がる」「夕方になると水辺の虫が気になって庭に出られない」「デッキの板が思ったより早く傷んだ」——大津で庭業者を探すきっかけには、湖に近い土地ならではの水気にまつわる悩みが関わってくることがあります。湖岸に近い平地でも、湖を見下ろす斜面の住宅地でも、水辺の空気と付き合う庭であることに変わりはありません。
            </p>
            <p>
              本記事では、大津市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「湿気がこもる場所を減らすことから始める手入れ」「水がたまる物を減らす虫との付き合い方」「湿気で傷みが早いウッドデッキ・木製フェンスの点検」「池・水鉢のある庭をどうするかの判断」といった、水辺に近い庭で手入れを頼むときの考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="otsu5" num="1">大津で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            大津市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月8日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月8日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、大津での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="sec2" num="2">水辺に近い庭は「湿気がこもる場所」を減らすことから始める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            大きな水面に近い土地では、風向きによって湿った空気が庭に入り込み、朝には葉や塀に水滴がつくような日があります。湿気そのものをなくすことはできませんが、<Hl>庭の中で空気が動かず、湿気がとどまる場所を減らすこと</Hl>はできます。家と塀の間の細い通路、密に茂った植え込みの内側、物置の裏、デッキの下といった場所は、日が差さず風も抜けないため、苔やカビが出やすく、木の株元が常に湿った状態になりがちです。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            手入れの基本は、<Hl>枝を透かして風の通り道を作ること</Hl>です。木を減らさなくても、混み合った枝を間引き、低木の厚みを減らすだけで、内側の空気は動くようになります。目隠しのために密に仕立てている木も、下枝を少し上げるだけで足元の風通しは変わります。目隠しと風通しの両立は<Link href="/mekakushi-niwaki/" className="text-[#2D7F3E] underline">目隠しになる庭木の選び方</Link>を、低木の厚みの整え方は<Link href="/teiboku-kanri/" className="text-[#2D7F3E] underline">低木・植え込みの管理の基本</Link>を参考にしてください。剪定110番は庭木1本から依頼でき、剪定1本2,890円〜（出張費3,000円別途）の掲載料金で、現地調査・見積もりは無料です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            地面に目を向けると、<Hl>苔が広がっている場所は、そこに湿気がとどまっていることのサイン</Hl>でもあります。苔を景観として活かすのか、対策するのかは<Link href="/niwa-koke-taisaku/" className="text-[#2D7F3E] underline">庭の苔対策の基本</Link>を参考に決めてください。水はけの悪さが原因で地面が乾かない場合は<Link href="/niwa-mizuhake/" className="text-[#2D7F3E] underline">庭の水はけ改善の考え方</Link>が役に立ちます。エアコンの室外機のまわりに植え込みが迫っていると、湿気と熱がこもって機器にも植物にもよくありません。距離の取り方は<Link href="/shitsugaiki-shokusai/" className="text-[#2D7F3E] underline">室外機まわりの植栽と注意点</Link>にまとめています。
          </p>

          <H2 id="sec3" num="3">水がたまる物を減らすことが、水辺の虫と付き合う基本</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            水辺に近い庭では、夕方に小さな虫が群れる、夏場に蚊が多い、といった悩みが尽きません。湖から飛んでくる虫を止めることはできませんが、<Hl>自分の庭の中で虫が増える条件を減らすこと</Hl>はできます。植木鉢の受け皿にたまった水、使っていないバケツやじょうろ、ふたの開いた雨水タンク、落ち葉で詰まった排水桝など、水がたまったままになる物は、庭の中で虫が育つ場所になります。まずはこうした物を見直すのが、道具も薬剤も要らない最初の対策です。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            雨水タンクを使っている場合は、<Hl>ふたを閉じて虫が入らないようにすること</Hl>が前提です。設置場所とあふれた水の行き先の考え方は<Link href="/amamizu-tank-katsuyo/" className="text-[#2D7F3E] underline">雨水タンクの活用と散水</Link>にまとめています。排水桝に落ち葉や泥がたまって水が抜けなくなっていないかは、自分で見られる範囲があります。手順は<Link href="/haisuimasu-tenken/" className="text-[#2D7F3E] underline">庭の排水桝の点検の基本</Link>をご覧ください。桝の先の配管の詰まりや改修は、庭業者ではなく指定工事事業者の範囲になります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            茂みそのものも、虫の隠れ場所になります。<Hl>足元の草を短く保ち、密な植え込みの内側に空間を作っておく</Hl>と、虫の居場所は減ります。草刈り110番は1平米600円〜という面積単価で、裏手や外周など範囲を決めて頼めるほか、刈った後の防草シート施工や定期メンテナンスプランも用意されています。庭木につく虫のサインの見分け方は<Link href="/kaigaramushi-aburamushi/" className="text-[#2D7F3E] underline">カイガラムシ・アブラムシ等の見分け方</Link>と<Link href="/niwaki-byogaichu/" className="text-[#2D7F3E] underline">庭木の病害虫対策の基本</Link>にまとめています。消毒を行う場合、薬剤は製品ラベルの記載に従って使うのが原則で、庭木に蜂の巣ができていた場合は剪定の前に<Link href="/niwaki-hachinosu/" className="text-[#2D7F3E] underline">庭木に蜂の巣ができたときの対処</Link>を確認してください。
          </p>

          <H2 id="sec4" num="4">ウッドデッキ・木製フェンスは湿気で傷みが早い——点検の目安</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            湿った空気が長くとどまる庭では、木でできた物の傷みが思ったより早く進みます。<Hl>ウッドデッキの床板の裏側、束柱の根元、木製フェンスの地面に近い部分</Hl>は、乾く時間が短く、表面がきれいに見えても内側から傷んでいることがあります。デッキの下に落ち葉や刈り草がたまっていると、湿気がさらに抜けにくくなり、傷みを早めます。踏んだときにたわむ、ねじが浮いている、表面が黒ずんでいる、といった変化は早めに気づきたいサインです。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            傷みのサインの見方と、修理するか交換するかの判断は<Link href="/wood-fence-rekka/" className="text-[#2D7F3E] underline">ウッドフェンスの劣化と交換判断</Link>と<Link href="/wooddeck-mawari-teire/" className="text-[#2D7F3E] underline">ウッドデッキ周りの手入れの基本</Link>にまとめています。レンガや枕木を使った小道や花壇の縁も、湿気で傷み方が変わります。目安は<Link href="/renga-makuragi-rekka/" className="text-[#2D7F3E] underline">レンガ・枕木の劣化と交換の判断</Link>をご覧ください。<Hl>デッキ下の草を刈り、砂利や防草シートで地面を覆っておく</Hl>と、湿気がこもりにくくなり、点検もしやすくなります。砂利の敷き方の基本は<Link href="/jarishiki/" className="text-[#2D7F3E] underline">庭の砂利敷きの基礎知識</Link>に、防草シートの性質は<Link href="/bousou-sheet/" className="text-[#2D7F3E] underline">防草シートの基礎知識</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            注意したいのは、<Hl>デッキやフェンス本体の補修・交換は、庭木の手入れとは担当が分かれることが多い</Hl>点です。デッキまわりの草刈りや落ち葉の片付け、デッキ下の砂利敷きは庭業者に相談できますが、構造にかかわる補修は施工した業者や外構の業者に相談することになります。どこまでを誰に頼むかの整理は<Link href="/niwa-reform-gaiko-chigai/" className="text-[#2D7F3E] underline">庭のリフォームと外構工事の違い</Link>が参考になります。作業単位で近隣の事業者を比べたいなら、くらしのマーケットで口コミ・料金を見比べ、デッキ下の作業まで含められるかを予約前のメッセージで確認してから頼む方法があります。
          </p>

          <H2 id="sec5" num="5">池・水鉢のある庭は「水を動かす」か「やめる」かを決める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            水辺の景色になじむ庭として、池や水鉢、小さな流れを作っている家もあります。水のある庭は季節の変化が楽しめる一方、<Hl>手入れが止まって水がよどむと、虫の発生源になり、においや落ち葉の腐敗の原因にもなります</Hl>。以前は家族の誰かが世話をしていたが今は誰も触っていない、という池は、庭の中で最も湿気と虫を生みやすい場所になっていることがあります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            判断の分かれ目は、<Hl>水を動かし続けるか、水をやめるか</Hl>です。続けるなら、落ち葉を取り除き、水が循環する仕組みを保ち、周囲の木の枝を減らして落ち葉と日陰を減らす手入れがセットになります。やめるなら、水を抜いて埋め戻すか、乾いた景色として石組みだけを残すかを決めることになります。使わなくなったときの扱いと安全面の考え方は<Link href="/ido-ike-kanri/" className="text-[#2D7F3E] underline">井戸・池のある庭の管理</Link>にまとめています。小さな子どもがいる家では、水深にかかわらず水のある場所は注意が必要で、<Link href="/kodomo-niwa-anzen/" className="text-[#2D7F3E] underline">子どもと庭遊びの安全対策</Link>も参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            池に給水や排水の配管がつながっている場合、その処理は<Hl>庭業者ではなく指定工事事業者の範囲</Hl>です。循環用のポンプや照明の電源にかかわる工事は電気工事士の範囲で、庭業者に頼める作業とは分けて考える必要があります。埋め戻したあとに石や灯篭を残すか撤去するかは<Link href="/niwaishi-toro-tekkyo/" className="text-[#2D7F3E] underline">庭石・灯篭の撤去の基礎知識</Link>を参考に決めてください。池まわりの木を毎年整え、落ち葉と日陰を減らす形で続けるなら、smileガーデンの定額制の年間管理プランのように回数を決めて任せる方法があります。周囲の大きな木を根元から整理するなら、伐採110番のように伐採後の木材処分まで一括で頼める選択肢もあります。
          </p>

          {/* 6｜選び方 */}
          <H2 id="erabikata" num="6">失敗しない庭業者の選び方4ステップ</H2>
          <p className="leading-loose mb-6 text-[#4a5443]">
            庭業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。「湿気がひどくなる前に早く片付けたいから」と最初の1社に即決する前に、数分の確認でトラブルの多くは防げます。
          </p>
          {steps.map((s) => (
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">大津の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            大津で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。湿気がこもる場所の枝を透かすなら樹種別の目安がある剪定110番、裏手や外周の草を範囲を決めて片付けるなら面積単価が分かりやすい草刈り110番、家との間に湿気を閉じ込めている大きな木の整理なら処分まで一括の伐採110番、剪定と病害虫の確認を毎年セットで任せるならsmileガーデン、作業単位で口コミと料金を見比べるならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            水辺に近い大津の庭では、湿気がこもる場所を減らすことから手入れを始めること、水がたまる物を減らして虫の増える条件を断つこと、木でできたデッキやフェンスは傷みが早い前提で点検すること、池や水鉢は水を動かすかやめるかを決めること、配管・電源・構造にかかわる作業は担当が分かれる領域だと切り分けること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwa-koke-taisaku/", label: "庭の苔対策の基本" },
                { href: "/wooddeck-mawari-teire/", label: "ウッドデッキ周りの手入れの基本" },
                { href: "/ido-ike-kanri/", label: "井戸・池のある庭の管理" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
