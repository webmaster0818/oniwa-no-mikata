...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】金沢の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "金沢で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、雪吊りなど冬支度の頼み方、庭園文化の土地で仕立てを意識した剪定を依頼する考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】金沢の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "金沢で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。雪吊りなど冬支度を業者に頼むときの確認ポイントや、松・仕立て物のある庭を計画的に維持する剪定の考え方、受け継いだ庭の維持レベルの決め方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、金沢市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。受け継いだ庭で管理しきれなくなった木の整理も、伐採から抜根・処分まで一度に相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        を使えば、雪のない季節に伸び続ける雑草の管理をまとめて任せられます。
      </>
    ),
    recommend: [
      "庭や空き地の雑草を低価格で片付けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。手入れの回数が多い庭を年間サイクルでまるごと任せる使い方にも向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。金沢市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、雪吊りなど冬支度への対応可否を確かめてから予約するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 「どこまで仕立てるか」の希望を写真とセットで伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、松や仕立て物のある庭では「どんな姿に整えたいか」で作業の内容が大きく変わります。今の庭の写真と、理想に近い仕上がりのイメージを用意して伝えると、見積もりの精度も提案の質も上がります。雪吊りなど冬支度の希望がある場合は、対応できるかどうかを最初に確認しておきましょう。",
  },
  {
  ...
  {
    t: "③ 冬支度の相談は「雪の便りが聞こえてから」では遅い",
    b: "雪吊りや冬囲いといった庭木の冬支度は、雪が積もる前に作業を終えておく必要があるため、依頼できる時期の幅がもともと狭い作業です。しかも対応できる業者が限られることもあり、直前になるほど選択肢が減ります。「今年は頼もうか」と考えているなら、秋を待たずに対応可否と費用の確認だけでも先に済ませておくのがおすすめです。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "金沢で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。松のように仕立てのある木は樹種や状態によって手間が変わるため、最低価格ではなく出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "雪吊りだけを業者に頼むことはできますか？",
    a: "雪吊りなど冬支度への対応可否は、業者や加盟店によって異なります。剪定と合わせて依頼できる場合もあれば、冬支度は扱っていない場合もあるため、依頼時に最初に確認しましょう。くらしのマーケットなら、予約前に出店者へメッセージで「雪吊りに対応できるか」を確かめたうえで依頼できます。",
  },
  {
    q: "雪吊りは自分でやってもよいのでしょうか？",
    a: "簡単な低木の冬囲いを自分で行う家庭はありますが、支柱を立てて縄で枝を吊る本格的な雪吊りは、縄の掛け方や締め具合を誤ると枝を傷めることがあり、脚立を使う高所作業の危険も伴います。見た目の美しさと枝を守る機能を両立させるのは職人の技術の領域と考えて、仕立てた松など大切な木はプロに任せるのが安心です。",
  },
  {
    q: "松の手入れは普通の剪定と何が違いますか？",
    a: "松は芽の摘み方や古葉の取り方など手入れの方法が独特で、時期も樹種ごとの慣例があり、一般的な庭木の刈り込みより手間がかかる傾向があります。そのぶん料金も高くなりやすいため、見積もり時に作業内容の内訳を確認しましょう。手入れの基本的な考え方は当サイトの松の手入れの解説記事でまとめています。",
  },
  {
    q: "庭木の冬支度はいつまでに済ませればよいですか？",
    a: "雪が積もる前に終えている必要があるため、逆算して余裕を持って依頼するのが基本です。初雪の時期は年によって変わるうえ、冬支度の依頼は同じ時期に集中しやすく、直前では希望日に予約が取れないこともあります。「今年やるかどうか」を迷っている段階でも、早めに見積もりだけ取っておくと判断しやすくなります。",
  },
  {
...
export default function AreaKanazawaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】金沢の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "金沢で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "金沢の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kanazawa5",
      label: "1｜金沢で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "金沢の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#yukitsuri", label: "2｜雪吊りは「冬の風物詩」である前に、枝を守る職人の技術" },
    { href: "#shitate", label: "3｜庭園文化の土地では「仕立てを意識した剪定」の目線で頼む" },
    { href: "#nenkan", label: "4｜冬支度と春からの手入れは「年間サイクル」で考える" },
    { href: "#hikitsugi", label: "5｜受け継いだ庭は「維持のレベル」を決めてから相談する" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜金沢の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">金沢の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「庭木の雪吊りをどこに頼めばいいのか分からない」「代々手入れされてきた庭を受け継いだけれど、同じ水準で維持できる自信がない」——金沢で庭業者を探す相談には、こうした「冬支度」と「仕立てられた庭の維持」の悩みがよく関わってきます。手入れの行き届いた庭が身近にある土地柄だからこそ、自宅の庭の枝の乱れや荒れが気になりやすく、いざ頼もうとすると「どこまでやってもらえるのか」「いくらかかるのか」が見えにくいものです。
            </p>
            <p>
              本記事では、金沢市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「雪吊りなど冬支度を業者に頼むときの確認ポイント」「松や仕立て物のある庭を計画的に維持する剪定の考え方」「受け継いだ庭の維持レベルの決め方」といった、雪国の庭と長く付き合うための依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kanazawa5" num="1">金沢で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            金沢市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月16日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月16日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、金沢での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜雪吊り */}
          <H2 id="yukitsuri" num="2">雪吊りは「冬の風物詩」である前に、枝を守る職人の技術</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            支柱を立てて縄で枝を吊る雪吊りは、雪の重みで枝が折れるのを防ぐための冬支度です。庭園の風景として親しまれている一方で、<Hl>縄の掛け方や締め具合には技術があり、見よう見まねで行うと枝を傷めたり、かえって特定の枝に負担が集中したりする</Hl>ことがあります。支柱を立てて高い位置で作業する危険もあるため、仕立てた松など大切な木の雪吊りは「職人の技術の領域」と考えて、無理に自己流で挑まないのが賢明です。庭木を支える基本の考え方は
            <Link href="/niwaki-shichu/" className="text-[#2D7F3E] underline">庭木の支柱の解説記事</Link>
            も参考になります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            注意したいのは、<Hl>雪吊りなど冬支度への対応可否が業者・加盟店によって異なる</Hl>ことです。剪定とセットで頼める場合もあれば、冬支度は扱っていない場合もあります。剪定110番のようなマッチング型のサービスに相談する際も、「雪吊りをお願いしたい」と最初に伝えて対応できる加盟店かを確認しましょう。くらしのマーケットなら、予約前に出店者へメッセージで対応可否と費用感を確かめられるため、冬支度の頼み先探しに向いています。
          </p>

          {/* 3｜仕立て */}
          <H2 id="shitate" num="3">庭園文化の土地では「仕立てを意識した剪定」の目線で頼む</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            兼六園に代表される庭園文化が根付いた土地では、松や仕立て物のある和風の庭が身近で、手入れの行き届いた庭を見る機会も自然と多くなります。そうした環境では、庭木の手入れは「伸びたから切る」だけでなく、<Hl>「どんな姿に整えるか」という仕立ての目線</Hl>が問われます。特に松は、芽の摘み方や古葉の取り方など手入れの方法が独特で、一般的な刈り込みとは手間のかかり方が違います。基本の考え方は
            <Link href="/matsu-teire/" className="text-[#2D7F3E] underline">松の手入れの解説記事</Link>
            でまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            仕立てを重視する剪定は、樹種ごとに適した時期を踏まえて計画的に行うことが大切です。時期を外した強い剪定は樹形を乱し、回復に時間がかかることもあります。適期の考え方は
            <Link href="/sentei-jiki/" className="text-[#2D7F3E] underline">剪定時期の解説記事</Link>
            を参考にしてください。剪定110番は樹種別の目安料金があり、現地調査・見積もりが無料なので、「この松をどう維持していくべきか」という相談から始められます。仕上がりの希望は、写真を使って具体的に伝えるのがコツです。
          </p>

          {/* 4｜年間サイクル */}
          <H2 id="nenkan" num="4">冬支度と春からの手入れは「年間サイクル」で考える</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            雪国の庭は、春の芽吹きに合わせた手入れ、夏の刈り込みや草刈り、秋の剪定と冬支度、雪解け後の片付けと、<Hl>季節ごとにやるべきことが一年を通して巡ります</Hl>。そのつど単発で頼んでいると、「気づいたら冬支度の適期を逃していた」「春の消毒を忘れていた」といった抜けが起こりがちです。庭の手入れをカレンダーに落とし込み、どの作業を自分でやり、どの作業をプロに任せるかを一度整理しておくと、毎年の負担が大きく減ります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            仕組みにする方法としては、smileガーデンの<Hl>定額制の年間管理プラン</Hl>のように剪定・消毒・施肥をセットで任せる形が代表的です。写真付きの作業報告書が受け取れるため、任せきりでも庭の状態を把握できます。スポットで頼む場合も、剪定110番・伐採110番は24時間365日受付なので、「次の作業の予定が決まった時点で予約する」を習慣にすれば、時期を逃しにくくなります。草刈りだけなら草刈り110番の定期メンテナンスプランで、雪のない季節の雑草管理をまとめて任せる方法もあります。
          </p>

          {/* 5｜受け継いだ庭 */}
          <H2 id="hikitsugi" num="5">受け継いだ庭は「維持のレベル」を決めてから相談する</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            親の代から職人の手が入ってきた庭を受け継ぐと、「同じように維持しなければ」という気持ちと、費用・手間の現実との間で悩みがちです。大切なのは、<Hl>庭全体を一律に守ろうとせず、「残して手をかける木」と「整理する木」を分ける</Hl>ことです。象徴になっている松は仕立てを続け、大きくなりすぎた木や役割の薄れた木は本数を減らす、といったメリハリをつければ、維持費用は現実的な範囲に収まります。庭を段階的に身軽にしていく考え方は
            <Link href="/niwajimai/" className="text-[#2D7F3E] underline">庭じまいの解説記事</Link>
            でもまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            本数を整理する場合は、伐採110番のように<Hl>伐採から抜根・処分まで一括で任せられる</Hl>サービスが便利です。残す木については、どの程度の頻度で手を入れれば現状を保てるのか、プロに現地を見てもらって年間の手入れ計画を相談しましょう。剪定110番・smileガーデンはいずれも見積もり無料なので、「維持にいくらかかるのか」を数字で把握してから方針を決められます。金額を見て初めて、残す木と整理する木の線引きが現実的に判断できるはずです。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">金沢の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            金沢で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。松など仕立てを意識した剪定なら樹種別の目安がある剪定110番、受け継いだ庭の本数整理なら処分まで一括の伐採110番、雪のない季節の雑草管理なら定期プランのある草刈り110番、季節ごとの手入れを年間サイクルで任せるならsmileガーデン、雪吊りなど冬支度の対応可否をメッセージで確かめてから頼むならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            雪と共にある庭の手入れは、冬支度を含めた一年のサイクルで考えることが出発点です。雪吊りなどの冬支度は対応可否を最初に確認して余裕を持って予約すること、仕立ての希望は写真で具体的に伝えること、受け継いだ庭は残す木と整理する木を分けて維持レベルを決めること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwaki-shichu/", label: "庭木の支柱の立て方と考え方" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
