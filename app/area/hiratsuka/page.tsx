...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】平塚の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "平塚で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・草刈り110番（1平米600円〜）・伐採110番・smileガーデン・くらしのマーケットの料金と特徴、物干しの上にあるもの、配達や検針など家族以外が通る動線、ウッドデッキやテラスの下と裏、出た枝葉を敷地の外へ出す量を減らす方法まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】平塚の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "平塚で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。物干しの上に何があるかで洗濯物に落ちてくるものが決まること、配達や検針やゴミ収集など家族以外が通る動線は自分では気づかないまま塞がっていること、デッキやテラスの下と裏は作ったあとでは手が入れにくいこと、出た枝葉を敷地の外へ出す量を減らす方法も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、平塚市内の依頼でも近隣の加盟店が対応します。
        <Hl>剪定1本2,890円〜の明朗会計</Hl>
        で、現地調査・見積もりは無料。見積もり後の追加料金がない点と、
        <Hl>24時間365日の受付</Hl>
        で庭木1本から相談できる点が特徴です。物干しの上や通路の脇など、場所を指定した依頼にも向いています。請負賠償保険にも加入しています。
      </>
    ),
    recommend: [
      "物干しの上や通路の脇など場所を指定して頼みたい人",
      "庭木1本からでも気軽に頼みたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        ため、範囲を決めて頼みやすいサービスです。通路や物干しまわりなど、使う場所だけを刈ってもらえます。刈った後の
        <Hl>防草シート施工や除草剤散布</Hl>
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。毎年同じ場所に落とすものが多い木を、整理する相談先になります。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "毎年同じ場所に落とすものが多い木を整理したい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。使う場所を毎年同じ状態に保ちたい庭では、年単位で任せる形が合います。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。平塚市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できます。作業の時間帯や在宅の都合を、予約前にやり取りできます。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
    recommend: [
      "作業の時間帯や在宅の都合を予約前に相談したい人",
      "料金を比較してから依頼したい人",
...
const steps = [
  {
    t: "① 庭を「眺める場所」ではなく「使う場所」として一周する",
    b: "物干しに立って上を見上げる、荷物を持った状態で門から玄関まで歩く、夜に同じ道を通る、デッキの端から下をのぞく——この四つをやると、ふだん気づかない困りごとが出てきます。家族は毎日通る道を無意識に避けて歩くため、塞がっていることに気づきません。気づいた場所を写真に撮り、「通れる幅と高さを確保してほしい」という言い方で伝えると、切る枝の選び方が変わります。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」「1平米◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・面積・庭の状況で変わります。デッキの下や通路の脇のような手の入れにくい場所は、同じ面積でも手間がかかることがあります。剪定枝や刈り草の処分費、出張費まで含めた総額を必ず作業前に確認してください。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料、くらしのマーケットは出店者ごとに料金が事前明示されます。",
  },
  {
    t: "③ 出たものを持ち帰ってもらう分と、敷地内に残す分を先に決める",
    b: "落ち葉や柔らかい草は時間をかけて土に返す、細い枝は砕いて地面に敷く、太めのまっすぐな枝は支柱として使う——という形で、外へ出す量を減らせることがあります。ただし、病気が出ていた葉や枝、種をたくさん付けた草、地下で広がる竹や笹の根は敷地内に残すと問題が広がるため分けて処分してください。残す分がある場合は「これは持ち帰らないでほしい」と作業前に伝え、置き場所も指定しておきましょう。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "同じ庭でも、業者によって得意分野や料金体系は異なります。場所を指定した細かい依頼に応じてくれるか、手の入れにくい場所まで作業できるか、出たものの一部を残す頼み方ができるかは、業者ごとに差が出やすい点です。デッキや木材そのものの傷みは庭業者ではなく建材や外構の業者の範囲になることがあるため、切り分けて相談してください。時間に余裕があれば2〜3社から見積もりを取り、総額・作業範囲・処分費の扱いを比較しましょう。",
  },
];

const faqs = [
  {
    q: "平塚で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。物干しの真上にかかる枝だけ、通路の脇の張り出しだけ、といった場所を指定した依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "洗濯物に落ちてくるものを減らしたいのですが、木を切るしかありませんか？",
    a: "木全体を小さくする必要はないことが多く、干す場所の真上にかかる枝だけを上げる頼み方で足りる場合があります。竿の位置に立って上を見上げた写真を渡すと伝わりやすくなります。また、落ちてくるものは花のあと、実の熟すころ、葉が柔らかい時期など限られた時期に集中するため、その時期だけ干す場所を変えるという対応もあり得ます。",
  },
  {
    q: "宅配や検針の人が通る場所は、どのくらい空けておけばよいですか？",
    a: "荷物を持った状態で門から玄関まで歩いてみると、避けられていた枝に当たるので分かります。高さは、傘をさして通れるか、荷物を肩に載せて通れるかを目安にすると具体的です。業者には「通れる幅と高さを確保してほしい」という言い方で伝えると、形を整えるのではなく人が通れる状態にすることが目的だと伝わります。通路の足元に伸びてくる下草も同じ範囲として頼むと一度で済みます。",
  },
  {
    q: "ウッドデッキの下に草が生えていますが、手が入りません。どうすればよいですか？",
    a: "すでに作ってある場合は、端から届く範囲を定期的に掃き出すことと、周囲から中へ入ってくる草の根を外側で止めることの二つで進めます。デッキの外周に沿って帯状に手を入れておくと、内側へ入る量が減ります。これから作る予定があるなら、下の地面に防草シートを敷いて砂利を入れておくと、あとから手を入れる必要がほとんどなくなります。木材そのものの傷みは、庭業者ではなく建材や外構の業者の範囲になることがあります。",
  },
  {
    q: "出た枝や落ち葉を庭で使い回すことはできますか？",
    a: "落ち葉や柔らかい草は時間をかけて土に返すことができ、細い枝は砕いて地面に敷けば草の抑えと土の乾燥防止を兼ねます。太めのまっすぐな枝は支柱や柵の材料として使い回せることがあります。ただし、病気が出ていた葉や枝、種をたくさん付けた草、地下で広がる竹や笹の根は敷地内に残すと問題が広がるため、分けて処分してください。残す分は作業前に伝え、置き場所も指定しておきましょう。",
  },
  {
...
export default function AreaHiratsukaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】平塚の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "平塚で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "平塚の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#hiratsuka5",
      label: "1｜平塚で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "平塚の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#monohoshi", label: "2｜物干しの上に何があるかで、洗濯物に落ちてくるものが決まる" },
    { href: "#dosen", label: "3｜配達・検針・ゴミ収集——家族以外が通る動線は、自分では気づかないまま塞がっている" },
    { href: "#deckshita", label: "4｜ウッドデッキやテラスの下と裏は、作ったあとでは手が入れにくい" },
    { href: "#genryo", label: "5｜出た枝葉を敷地の外へ出す量を減らす——堆肥・チップ・支柱としての使い道" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜平塚の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">平塚の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「洗濯物に虫や花がらが落ちてきて、干す場所を変えた」「宅配の人が通る脇の枝が張り出していると、あとから気づいた」「デッキの下に草が生えているのに、手が入らない」——平塚で庭業者を探すきっかけには、庭を眺めたときではなく、庭を毎日使っているときに気づく困りごとがあります。
            </p>
            <p>
              本記事では、平塚市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「物干しの上にあるもの」「配達や検針など家族以外が通る動線」「デッキやテラスの下と裏」「出た枝葉を敷地の外へ出す量を減らす方法」といった、平塚で特に確認しておきたい依頼の進め方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="hiratsuka5" num="1">平塚で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            平塚市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月25日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月25日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、平塚での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="monohoshi" num="2">物干しの上に何があるかで、洗濯物に落ちてくるものが決まる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            洗濯物を干す場所は、<Hl>たいてい日当たりで決めます</Hl>。そして多くの家では、日当たりのよい場所に木も植わっています。結果として、<Hl>干す場所の上に枝が張り出している</Hl>状態になりがちです。ふだんは気にならなくても、季節によって落ちてくるものが変わります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            落ちてくるものは、<Hl>花がら、花びら、実、樹液、虫、鳥の落とし物</Hl>などです。時期も決まっていて、花の咲く木なら花のあと、実のなる木なら実の熟すころ、虫のつく木なら葉が柔らかい時期に集中します。<Hl>一年を通して問題になるのではなく、限られた時期に集中する</Hl>ため、「その時期だけ干す場所を変える」という対応もあり得ます。毛虫への注意は<Link href="/kemushi-chui/" className="text-[#2D7F3E] underline">毛虫への注意の解説記事</Link>、殻に覆われた虫が出す樹液は<Link href="/kaigaramushi-aburamushi/" className="text-[#2D7F3E] underline">カイガラムシ・アブラムシの解説記事</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            木のほうを変えるなら、<Hl>干す場所の真上にかかる枝だけを上げる</Hl>という頼み方ができます。木全体を小さくする必要はなく、<Hl>物干し竿の真上を空けるところまで</Hl>で足りることが多くあります。業者には、竿の位置に立って上を見上げた写真を渡すと伝わります。室外機や設備が近くにある場合は、そのまわりの植栽もあわせて確認しておきましょう。<Link href="/shitsugaiki-shokusai/" className="text-[#2D7F3E] underline">室外機まわりの植栽の解説記事</Link>、落ち葉全般は<Link href="/ochiba-taisaku/" className="text-[#2D7F3E] underline">落ち葉対策の解説記事</Link>を参考にしてください。剪定110番は庭木1本から相談でき、現地調査・見積もりは無料です。
          </p>

          {/* 3 */}
          <H2 id="dosen" num="3">配達・検針・ゴミ収集——家族以外が通る動線は、自分では気づかないまま塞がっている</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            家族は、<Hl>毎日通る道を無意識によけて歩いています</Hl>。張り出した枝があっても、体が勝手に避けるため、塞がっていることに気づきません。ところが、<Hl>初めて来る人、荷物を抱えている人、早朝や夜に来る人</Hl>には、そのままぶつかります。宅配、郵便、検針、ゴミの収集——家族以外が通る動線は、いくつもあります。宅配ボックスまわりの考え方は<Link href="/takuhaibox-gaiko/" className="text-[#2D7F3E] underline">宅配ボックスと外構の解説記事</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            確かめ方は単純で、<Hl>荷物を持った状態で、門から玄関まで歩いてみる</Hl>ことです。片手がふさがっていると、避けられていた枝に当たります。<Hl>夜に同じ道を歩いてみる</Hl>のも有効で、足元が見えない状態でつまずく段差や、伸びた下草が分かります。門から玄関までの通路、メーターの前、ゴミを出す場所までの道——この三つを順に見てください。足元の明かりは<Link href="/niwa-shomei-keikaku/" className="text-[#2D7F3E] underline">庭の照明計画の解説記事</Link>、自転車の出し入れの動線は<Link href="/jitensha-okiba-dosen/" className="text-[#2D7F3E] underline">自転車置き場と動線の解説記事</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            業者に頼むときは、<Hl>「通れる幅と高さを確保してほしい」という言い方</Hl>にすると意図が伝わります。形をどう整えるかではなく、<Hl>人が通れる状態にすることが目的だ</Hl>と分かれば、切る枝の選び方が変わります。高さについては、傘をさして通れるか、荷物を肩に載せて通れるかを目安にすると具体的です。あわせて、<Hl>通路の足元に伸びてくる下草</Hl>も同じ範囲として頼んでおくと、一度で済みます。飛び石まわりの草は<Link href="/tobiishi-zasso/" className="text-[#2D7F3E] underline">飛び石まわりの雑草の解説記事</Link>にまとめています。
          </p>

          {/* 4 */}
          <H2 id="deckshita" num="4">ウッドデッキやテラスの下と裏は、作ったあとでは手が入れにくい</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            デッキやテラスは、<Hl>地面から少し浮かせて作られます</Hl>。その下の空間は、日が当たらず、風は通り、雨は吹き込むという、<Hl>掃除しにくいわりに物がたまりやすい条件</Hl>がそろっています。落ち葉が吹き込んで積もり、草が伸び、猫が入り込むこともあります。デッキまわりの手入れは<Link href="/wooddeck-mawari-teire/" className="text-[#2D7F3E] underline">ウッドデッキまわりの手入れの解説記事</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            厄介なのは、<Hl>手を入れようとしても入り口がないこと</Hl>です。高さがあれば潜れますが、低いデッキでは腕しか入りません。草が伸びてきて初めて気づき、そのときにはもう根が張っています。<Hl>これから作る予定があるなら、下の地面を先に仕上げておく</Hl>のが最善です。防草シートを敷いて砂利を入れておけば、あとから手を入れる必要がほとんどなくなります。地面を覆う方法は<Link href="/bousou-sheet/" className="text-[#2D7F3E] underline">防草シートの解説記事</Link>と<Link href="/jarishiki/" className="text-[#2D7F3E] underline">砂利敷きの解説記事</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            すでに作ってある場合は、<Hl>端から届く範囲だけでも定期的に掃き出す</Hl>ことと、<Hl>周囲から中へ入ってくる草の根を、外側で止める</Hl>ことの二つで進めます。デッキの外周に沿って帯状に手を入れておけば、内側へ入る量が減ります。木材そのものの傷みについては、<Hl>庭業者ではなく建材や外構の業者の範囲</Hl>になることがあるため、切り分けて相談してください。木材の傷みは<Link href="/wood-fence-rekka/" className="text-[#2D7F3E] underline">木製フェンスの劣化の解説記事</Link>と<Link href="/renga-makuragi-rekka/" className="text-[#2D7F3E] underline">レンガ・枕木の劣化の解説記事</Link>にまとめています。草刈り110番は1平米600円〜の面積単価で、帯状の範囲を決めて頼みやすいサービスです。
          </p>

          {/* 5 */}
          <H2 id="genryo" num="5">出た枝葉を敷地の外へ出す量を減らす——堆肥・チップ・支柱としての使い道</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭の作業で出るものは、<Hl>量が多いほど処分の費用と手間がかかります</Hl>。業者に持ち帰ってもらえば楽ですが、その分は費用に乗ります。自分で出すにしても、<Hl>家庭ごみの量には限りがあり、一度では出しきれない</Hl>ことがあります。処分のルールは<Link href="/senteieda-shobun/" className="text-[#2D7F3E] underline">剪定枝の処分の解説記事</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            そこで、<Hl>外へ出す量そのものを減らす</Hl>という考え方があります。落ち葉と柔らかい草は、<Hl>時間をかけて土に返す</Hl>ことができます。庭の隅に置き場所を決めて積んでおく方法で、量が多い家ほど効きます。細い枝は、<Hl>砕いて地面に敷く</Hl>と、草の抑えと土の乾燥防止を兼ねます。太めのまっすぐな枝は、<Hl>支柱や柵の材料として使い回せる</Hl>ことがあります。堆肥にする方法は<Link href="/ochiba-taihi-compost/" className="text-[#2D7F3E] underline">落ち葉の堆肥化の解説記事</Link>、砕く道具は<Link href="/garden-shredder-katsuyo/" className="text-[#2D7F3E] underline">ガーデンシュレッダーの活用の解説記事</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            ただし、<Hl>向かないものもあります</Hl>。病気が出ていた葉や枝、種をたくさん付けた草、地下で広がる竹や笹の根は、敷地内に残すと問題が広がります。これらは分けて処分してください。業者に頼むときは、<Hl>「この分は残すので持ち帰らないでほしい」と作業前に伝える</Hl>ことと、<Hl>置き場所を指定しておく</Hl>ことの二つで話が通ります。残す量が読めない場合は、まず持ち帰りありで見積もりを取り、そのうえで減らせるか相談するのが確実です。病害虫の扱いは<Link href="/niwaki-byogaichu/" className="text-[#2D7F3E] underline">庭木の病害虫の解説記事</Link>、竹は<Link href="/take-taisaku/" className="text-[#2D7F3E] underline">竹の対策の解説記事</Link>にまとめています。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">平塚の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            平塚で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。物干しの上や通路の脇など場所を指定して頼むなら1本単位の剪定110番、毎日使う場所だけを決めて刈るなら面積単価の草刈り110番、毎年同じ場所に落とすものが多い木を整理するなら処分まで一括の伐採110番、使う場所を毎年同じ状態に保ちたいなら年間管理プランのsmileガーデン、作業の時間帯や在宅の都合を予約前に相談するならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            庭の困りごとは、眺めているときではなく使っているときに見つかります。物干しの上にかかる枝だけを上げれば足りることが多いこと、家族以外が通る動線は荷物を持って歩いてみると分かること、デッキやテラスの下は作る前に地面を仕上げておくのが最善であること、出た枝葉は外へ出す量そのものを減らせること、そして病気の葉や地下で広がる根は敷地内に残さないことが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
