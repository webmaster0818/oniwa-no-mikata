...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】鳥取の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "鳥取で剪定・伐採・草刈りを頼める庭業者を比較。草刈り110番（1平米600円〜）・剪定110番（1本2,890円〜）・伐採110番・smileガーデン・くらしのマーケットの料金と特徴、砂まじりの土の庭で水もちと養分の抜けにどう向き合うか、地面を覆う対策の考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】鳥取の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "鳥取で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。砂まじりの土の庭で起きやすい水もちと養分の課題、風で動く土を落ち着かせる地面の覆い方、水がたまる場所の見つけ方、土を入れ替える前の確認も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        <Hl>防草シート施工や除草剤散布</Hl>
        もあわせて依頼できるため、刈り取りと、地面を覆って土の飛散や雑草を抑える対策を、ひとつの相談にまとめられます。
        <Hl>定期メンテナンスプラン</Hl>
        で回数と時期を決めておくこともできます。
      </>
    ),
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、鳥取市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。庭を作り替える前段として木を減らしたい場合も、伐採から抜根、処分まで一度に相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "庭を作り替える前に木を減らしたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。土や植栽の状態を毎年同じ目で見てもらえるため、少しずつ庭の条件を整えていきたい場合にも向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。鳥取市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、防草シートの施工など希望する作業に対応できるかを確かめてから予約するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 困っている場所と症状を、写真とセットで伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、土が乾きやすい、水がたまる、草がすぐ生えるといった症状は、庭のどの部分で起きているのかを具体的に伝えましょう。写真があると現地を見る前でも状況が伝わり、見積もりの精度も提案の質も上がります。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」「1平米◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・面積・庭の状況で変わります。刈り草や剪定枝の処分費、出張費まで含めた総額を必ず作業前に確認しましょう。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料、くらしのマーケットは出店者ごとに料金が事前明示されるため、金額を見てから判断できます。",
  },
  {
    t: "③ 一度で終わらせる作業か、続ける作業かを分ける",
    b: "草を刈るのは繰り返し必要な作業ですが、地面を覆う対策は一度やれば効果が続く作業です。どちらを選ぶかで費用のかかり方が変わります。今回だけ片付けたいのか、来年以降の手間も減らしたいのかを最初に決めて、その前提で見積もりを取りましょう。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "鳥取で庭の草刈りだけを頼むことはできますか？",
    a: "できます。草刈り110番は草刈り・除草に特化したサービスで、1平米600円〜の掲載料金です。面積と草の状態で総額が変わるため、刈りたい範囲を伝えたうえで見積もりを確認しましょう。刈った後に防草シートを敷く、除草剤を散布するといった対策もあわせて相談できます。",
  },
  {
    q: "庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。樹種や高さによって手間が変わるため、最低価格ではなく出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "土がすぐ乾くのですが、土を入れ替えたほうがよいですか？",
    a: "入れ替えが唯一の方法というわけではありません。有機物を混ぜて土の状態を改善していく方法や、乾きやすい条件に合う植物を選ぶ方法もあります。入れ替えは量が増えるほど費用と処分の手間が大きくなるため、まずは困っている場所を絞り、現地を見てもらったうえで方法を決めるのが現実的です。",
  },
  {
    q: "砂利を敷けば雑草は生えなくなりますか？",
    a: "砂利を敷くと生えにくくはなりますが、まったく生えなくなるわけではありません。砂利の隙間に土やほこりがたまると、そこから草が出てきます。防草シートを併用する、厚みを確保するといった条件で効果は変わります。当サイトの砂利敷きと防草シートの解説記事に考え方をまとめていますので、あわせてご覧ください。",
  },
  {
  ...
  {
    q: "風の強い日に土が飛んで困っています。対策はありますか？",
    a: "むき出しの地面を覆うことが基本的な対策になります。砂利を敷く、防草シートと組み合わせる、地面を覆う植物を植えるといった方法があり、それぞれ費用と手間が違います。面積が広い場合は自力での作業が負担になるため、草刈りから地面を覆う作業までまとめて業者に相談する方法もあります。",
  },
];
...
export default function AreaTottoriPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】鳥取の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "鳥取で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "鳥取の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#tottori5",
      label: "1｜鳥取で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "鳥取の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#sec2", label: "2｜砂まじりの土は「水もち」と「養分の抜け」が課題になりやすい" },
    { href: "#sec3", label: "3｜風で動く土や砂は「地面を覆う」ことで落ち着かせる" },
    { href: "#sec4", label: "4｜水はけがよい庭にも、水がたまる場所はできる" },
    { href: "#sec5", label: "5｜土を入れ替える前に、現状を見てもらってから決める" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜鳥取の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">鳥取の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「水をやってもすぐ乾いてしまう」「肥料をあげても効いている実感がない」「風の強い日に土や砂が舞う」——鳥取で庭の相談を考えるとき、こうした土まわりの悩みが背景にあることがあります。土の性質は目に見えにくいため、植物がうまく育たない原因が土にあると気づくまでに時間がかかりがちです。
            </p>
            <p>
              本記事では、鳥取市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「砂まじりの土で起きやすいこと」「風で動く土を落ち着かせる地面の覆い方」「水はけがよい庭でも水がたまる場所ができる理由」「土を入れ替える前に確認したいこと」といった、土から庭を考えるための依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="tottori5" num="1">鳥取で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            鳥取市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月2日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月2日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、鳥取での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="sec2" num="2">砂まじりの土は「水もち」と「養分の抜け」が課題になりやすい</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            土の性質は、大きく分けて水を抱えやすい土と、水がすぐ抜ける土があります。<Hl>砂の割合が多い土は水はけがよい反面、水もちと養分を保つ力が弱い</Hl>という特徴があり、乾きやすく、与えた肥料分も流れ出やすくなります。同じ水やりをしていても他の土地より早く乾く、という感覚がある庭では、この性質が関わっている可能性があります。土の見極めと改良の基本は<Link href="/kadan-tsuchizukuri/" className="text-[#2D7F3E] underline">花壇の土づくりの基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            改善の方向は、<Hl>有機物を混ぜて土の構造そのものを変えていくこと</Hl>です。ただし土づくりは短期間で終わる作業ではなく、時間をかけて進めるものです。肥料は養分を与える資材、堆肥や腐葉土は土を良くする資材で役割が違うため、置き換えることはできません。与える量は製品ラベルの記載に従ってください。植物側から合わせる方法もあり、乾きやすい場所に何を植えるかは<Link href="/shokusai-haichi-keikaku/" className="text-[#2D7F3E] underline">植栽の配置計画の立て方</Link>や<Link href="/teire-raku-niwaki/" className="text-[#2D7F3E] underline">手入れが楽な庭木の選び方</Link>が参考になります。
          </p>

          <H2 id="sec3" num="3">風で動く土や砂は「地面を覆う」ことで落ち着かせる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            土がむき出しの場所は、乾けば風で舞い、雨が降れば流れます。<Hl>地面を覆っておくことは、土の飛散を抑えると同時に、乾燥をやわらげ、雑草を出にくくする</Hl>という複数の効果があります。覆い方には、砂利を敷く、防草シートを併用する、植物で覆う、といった選択肢があり、それぞれ手間と費用のバランスが違います。比較は<Link href="/zasso-taisaku/" className="text-[#2D7F3E] underline">雑草対策の方法比較</Link>にまとめました。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            砂利敷きは施工が分かりやすく、必要量の考え方も整理しやすい方法です。詳しくは<Link href="/jarishiki/" className="text-[#2D7F3E] underline">庭の砂利敷きの基礎知識</Link>と<Link href="/bousou-sheet/" className="text-[#2D7F3E] underline">防草シートの基礎知識</Link>をご覧ください。植物で覆う方法は<Link href="/groundcover-erabikata/" className="text-[#2D7F3E] underline">グランドカバープランツの選び方</Link>が参考になります。<Hl>面積が広いほど自力での作業は負担が大きくなる</Hl>ため、草刈り110番のように1平米600円〜の掲載料金で面積の見当がつくサービスに、刈り取りから防草シート施工まで相談する方法もあります。
          </p>

          <H2 id="sec4" num="4">水はけがよい庭にも、水がたまる場所はできる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            水はけがよい土地でも、庭全体が均一とは限りません。<Hl>建物のまわりを埋め戻した部分、車が通って踏み固められた部分、後から土を入れた部分では、水の抜け方が違う</Hl>ためです。雨のあとに水たまりが残る、いつまでもぬかるむ、といった場所があるなら、その一角だけ条件が違う可能性があります。原因の切り分け方は<Link href="/niwa-mizuhake/" className="text-[#2D7F3E] underline">庭の水はけ改善の考え方</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            あわせて確認したいのが、雨水の出口です。屋外の桝に土や落ち葉がたまると水の流れが悪くなります。自分で見られる範囲は<Link href="/haisuimasu-tenken/" className="text-[#2D7F3E] underline">庭の排水桝の点検の基本</Link>をご覧ください。<Hl>水がたまる場所は、根が傷みやすく、苔も出やすくなります</Hl>。苔への向き合い方は<Link href="/niwa-koke-taisaku/" className="text-[#2D7F3E] underline">庭の苔対策の基本</Link>を参考にしてください。原因が地面の下にある場合、掘る作業や土の入れ替えが必要になることがあり、その場合は現地を見てもらったうえで判断するのが確実です。
          </p>

          <H2 id="sec5" num="5">土を入れ替える前に、現状を見てもらってから決める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            土に問題があると分かると、まるごと入れ替えたくなりますが、<Hl>土の入れ替えは量が多くなるほど費用も処分の手間も大きくなる作業</Hl>です。庭全体を入れ替えなくても、植える場所だけを部分的に改良すれば足りることもあります。まずは、困っているのが庭のどこで、何が育たないのかを整理しましょう。写真と一緒に伝えると、現地調査での話が早くなります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            相談先は、作業の内容によって変わります。木を減らして日当たりや風通しを変えたいなら剪定110番、大きくなりすぎた木を根元から処理したいなら伐採110番（伐採後の木材処分まで一括対応をうたっています）、草を刈って地面を覆う対策までまとめたいなら草刈り110番が候補です。年間を通して庭全体を見てもらいたい場合は、smileガーデンの定額制の年間管理プランのような形もあります。作業単位で近隣の事業者を比べたいなら、くらしのマーケットで口コミと料金を見比べる方法もあります。工事の区分については<Link href="/niwa-reform-gaiko-chigai/" className="text-[#2D7F3E] underline">庭のリフォームと外構工事の違い</Link>も参考にしてください。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">鳥取の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            鳥取で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。草を刈って地面を覆う対策までまとめたいなら面積単価が分かりやすい草刈り110番、庭木1本からの剪定なら樹種別の目安がある剪定110番、大きくなりすぎた木の処理なら処分まで一括の伐採110番、庭全体を年間で任せるならsmileガーデン、作業単位で口コミと料金を見比べるならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            土の性質は目に見えにくく、水やりや肥料の効き方に静かに影響します。乾きやすい土では有機物で少しずつ改善すること、むき出しの地面は覆って飛散と乾燥と雑草をまとめて抑えること、水がたまる場所は地面の下の条件を疑うこと、土の入れ替えは範囲を絞って判断すること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/jarishiki/", label: "庭の砂利敷きの基礎知識" },
