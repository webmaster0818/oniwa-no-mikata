...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】名古屋の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "名古屋で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、実家・親の家の大きくなりすぎた庭木の管理、大径木化した庭木の剪定と伐採の判断まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】名古屋の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "名古屋で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。実家・親の家の庭木の世代交代や、大きくなりすぎた庭木の伐採判断など、名古屋で多い悩みに合わせた注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、名古屋市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。手入れされないまま大きくなった実家の庭木のように、個人では手に負えない木でも、切り倒しから後片付けまでまとめて相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "隣家や道路に近い危険な木の伐採を安全に任せたい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        を使えば、誰も住んでいない実家の敷地や空き地の雑草管理を任せきりにできます。
      </>
    ),
    recommend: [
      "庭や空き地の雑草を低価格で片付けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        <Hl>写真付きの作業報告書</Hl>
        が受け取れるため、離れて暮らす親の家の庭を子ども世代が代わりに管理したい場合にも、作業の様子を確認できます。見積もり・出張は無料です。
      </>
    ),
    recommend: [
      "一年を通して庭の手入れを定額で任せたい人",
      "離れて暮らす親の家の庭を報告書で確認しながら管理したい人",
      "剪定・消毒・施肥をセットでまとめたい人",
      "庭木の健康診断から相談したい人",
    ],
    table: [
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。名古屋市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、離れて暮らす実家の庭について写真を送って相談するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 作業内容と庭の状況を整理する",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのか、対象の木の種類・高さ・本数、庭のおおよその広さをメモしておくと、電話やフォームでの見積もり精度が上がります。実家・親の家の庭の場合は、帰省したときにスマートフォンで庭全体と気になる木を撮影しておくと、離れた場所からでも見積もり相談がしやすくなります。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・庭の状況で変わります。特に長年手入れされず大きくなった木は、高所作業や処分する枝の量が増えるぶん金額も上がりやすいため、剪定枝の処分費・出張費まで含めた総額を必ず作業前に確認しましょう。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料です。",
  },
  {
    t: "③ 誰が立ち会うか・誰が支払うかを決めておく",
    b: "実家や親の家の庭を子ども世代が手配する場合、「見積もりや作業当日に誰が立ち会うのか」「支払いは親か子か」を事前に決めておくとスムーズです。高齢の親だけで立ち会う場合は、見積もり内容を写真やメールで共有してもらい、家族で金額を確認してから契約すると、言った言わないのトラブルを防げます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "名古屋で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "離れて暮らす親の家（実家）の庭を、子どもの私が代わりに依頼できますか？",
    a: "多くのサービスで家族による手配は可能です。剪定110番は24時間365日受付のため、仕事の合間にも相談しやすく、smileガーデンは写真付きの作業報告書で作業の様子を確認できます。くらしのマーケットはメッセージで事前に庭の写真を送って相談できます。見積もり・作業当日の立ち会いを誰がするか、支払い方法をどうするかは、依頼時に各サービスへ確認してください。",
  },
  {
    q: "大きくなりすぎた庭木は、剪定と伐採のどちらを頼むべきですか？",
    a: "その木を今後も残したいかどうかで考えるのが基本です。残したい場合は剪定で高さと枝のボリュームを整え、以後は定期的な手入れで維持します。今後手入れをする人がいない、建物や隣家に近くて危険、といった場合は伐採も選択肢になります。判断に迷う場合は、剪定と伐採の両方の見積もりを取って費用と今後の管理の手間を比較するのがおすすめです。伐採110番は見積もり無料で、伐採後の木材処分まで一括対応をうたっています。",
  },
  {
...
export default function AreaNagoyaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】名古屋の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "名古屋で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "名古屋の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#nagoya5",
      label: "1｜名古屋で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "名古屋の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#jikka", label: "2｜実家・親の家の庭木は「世代交代」のタイミングで見直す" },
    { href: "#handan", label: "3｜大きくなりすぎた庭木は「剪定で維持」か「伐採」かを判断" },
    { href: "#enkaku", label: "4｜離れて暮らす家族が代わりに依頼するときのポイント" },
    { href: "#shobun", label: "5｜剪定枝・刈り草の処分は総額で確認を" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜名古屋の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">名古屋の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「実家の庭木が二階の屋根を越えるほど大きくなってしまった」「親が高齢になり、これまでのように庭の手入れができなくなった」——名古屋で庭業者を探す方から多く聞かれるのが、こうした実家・親の家の庭にまつわる悩みです。庭付きの戸建てで長く暮らしてきた親世代が手入れをしてきた庭木は、世代交代のタイミングで一気に「管理する人のいない木」になりがちです。数年放置しただけで木は想像以上に大きくなり、素人の手には負えなくなります。
            </p>
            <p>
              本記事では、名古屋市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「実家の庭木の世代交代」「大径木化した庭木を剪定で維持するか伐採するかの判断」「離れて暮らす家族が代わりに依頼する方法」といった、名古屋の相談で特に多いテーマの考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="nagoya5" num="1">名古屋で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            名古屋市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月12日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月12日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、名古屋での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜実家の庭木 */}
          <H2 id="jikka" num="2">実家・親の家の庭木は「世代交代」のタイミングで見直す</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            長年親世代が手入れをしてきた庭は、手入れをする人が変わる・いなくなるタイミングで管理の仕組みごと見直すのがおすすめです。<Hl>「親がやっていたから何とかなっていた」庭は、手が入らなくなると数年で様変わりします</Hl>。庭木は伸び放題になり、落ち葉や雑草で近隣に気を使う場面も増えていきます。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            見直しの選択肢は大きく3つです。ひとつは、smileガーデンのような<Hl>定額制の年間管理プラン</Hl>に切り替えて、剪定・消毒・施肥を業者に任せる方法。ふたつめは、手入れの負担が大きい木を思い切って伐採し、<Hl>管理しやすい本数・大きさまで庭を整理する</Hl>方法。みっつめは、当面はスポットで剪定・草刈りを頼みながら様子を見る方法です。どれが正解ということはなく、「今後この庭を誰がどれくらいの頻度で見られるのか」から逆算して決めるのが失敗しないコツです。
          </p>

          {/* 3｜剪定か伐採か */}
          <H2 id="handan" num="3">大きくなりすぎた庭木は「剪定で維持」か「伐採」かを判断</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            手入れされないまま大きくなった庭木について、剪定で小さくして残すか、伐採してしまうかは多くの方が迷うポイントです。判断の軸はシンプルで、<Hl>「その木を今後も管理し続けられるか」</Hl>です。木は一度強く切り詰めても、生きている限りまた伸びます。つまり剪定を選ぶことは、今後も定期的に手入れを続けることを選ぶということです。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            思い出のある木で今後も家族が手入れを続けられるなら、剪定で高さを抑えて管理しやすい状態に戻すのがよいでしょう。一方、<Hl>今後手入れをする人がいない、枝が電線や隣家に近く危険、建物に影響が出ている</Hl>といった場合は、伐採・抜根が現実的な選択肢になります。伐採110番のような専門サービスなら、大木・高木の特殊伐採から伐採後の木材処分まで一括で相談でき、見積もりは無料です。迷ったら、剪定と伐採の両方で見積もりを取り、費用と今後の管理の手間を並べて比較しましょう。
          </p>

          {/* 4｜遠隔依頼 */}
          <H2 id="enkaku" num="4">離れて暮らす家族が代わりに依頼するときのポイント</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            親が高齢で自分では手配が難しい場合、離れて暮らす子ども世代が代わりに業者を手配するケースは珍しくありません。その際に押さえたいのは、<Hl>「状況の共有」「立ち会い」「作業結果の確認」の3点</Hl>です。まず、帰省時に庭の写真を撮っておくか、親に送ってもらい、見積もり時に共有します。くらしのマーケットのようにメッセージで事前相談できるサービスは、この点で使いやすい仕組みです。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            作業当日の立ち会いを高齢の親だけに任せる場合は、<Hl>契約内容と金額を家族が事前に確認しておく</Hl>ことが大切です。また、smileガーデンの写真付き作業報告書のように、作業の仕上がりを離れた場所から確認できる仕組みがあると、頼みっぱなしにならずに済みます。剪定110番は24時間365日受付のため、仕事が終わった夜の時間帯でも相談の電話ができます。
          </p>

          {/* 5｜処分 */}
          <H2 id="shobun" num="5">剪定枝・刈り草の処分は総額で確認を</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            大きくなった木の剪定・伐採では、出てくる枝や幹の量も相当なものになります。家庭ごみとして出す場合、<Hl>長さ・束ね方・一度に出せる量などのルールは市区町村ごとに定められており</Hl>、量が多いと一度に出しきれません。実家の庭の整理では特に、処分まで含めて業者に任せるほうが現実的なことが多いでしょう。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            業者に依頼する場合は、<Hl>処分費まで含めた総額</Hl>を見積もり時に確認するのがポイントです。伐採110番は伐採後の木材処分まで一括対応をうたっています。処分費が料金に含まれるかどうかはサービス・加盟店により異なるため、「処分込みの金額かどうか」を必ず確認しましょう。あわせて、作業車の駐車スペースの有無や庭までの経路も伝えておくと、当日の追加費用や作業変更のリスクを減らせます。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">名古屋の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            名古屋で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。庭木1本からの剪定なら剪定110番、大きくなりすぎた木の伐採と処分なら伐採110番、空き家・実家の雑草対策なら草刈り110番、一年を通した定額管理ならsmileガーデン、口コミで地域の業者を選びたいならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            実家・親の家の庭は、手入れをする人が変わるタイミングが見直しの好機です。処分費・出張費を含めた総額の見積もりを作業前に確認すること、そして「今後この庭を誰が管理するのか」から逆算して剪定・伐採・年間管理を選ぶことが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
