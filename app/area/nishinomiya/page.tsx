...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】西宮の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "西宮で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・草刈り110番（1平米600円〜）・伐採110番・smileガーデン・くらしのマーケットの料金と特徴、花芽ができる時期から剪定時期を決める考え方、花がら・花びら・実の始末まで含めた依頼範囲の決め方、咲かせる高さの決め方、花つきが落ちた木で株元と土を見る手順まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】西宮の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "西宮で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。花を見るために植えた木は花芽ができる時期から剪定時期が決まること、花のあとに落ちる花がら・花びら・実の始末まで含めて頼む範囲を決めること、大きくなった花木は咲かせる高さを先に決めること、花つきが落ちた木は切り方より株元と土を疑うことも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、西宮市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。西宮市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
...
const steps = [
  {
    t: "① 「この木は花を見たい」と伝え、咲いている時期の写真を一枚添える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、どの木で花を見たいのかをはっきり伝えましょう。咲いている時期に撮った写真が一枚あると、どこに花がつく木なのかが伝わり、切ってよい枝の判断がしやすくなります。あわせて、現在の高さが分かる一枚と、株元と地面が分かる一枚も撮っておきましょう。花が終わった直後に頼みたい場合は、例年いつごろ咲き終わるのかを添えておくと、日程の相談が早く進みます。",
  },
  {
    t: "② 処分費・出張費を含めた総額の見積もりを取る",
    b: "「1本◯◯円〜」「1平米◯◯円〜」という表示は最低価格で、実際は樹種・高さ・本数・面積・庭の状況で変わります。花が終わった直後は依頼が重なりやすく、希望の時期に入れるかどうかで日程が動くことがあります。落ちた花や実の片付けまで頼むのか、切った枝だけ持ち帰ってもらうのかでも総額は変わるため、作業範囲を決めたうえで見積もりを取りましょう。剪定枝や刈り草の処分費、出張費まで含めた総額を必ず作業前に確認してください。剪定110番・伐採110番・smileガーデンはいずれも見積もり無料、くらしのマーケットは出店者ごとに料金が事前明示されます。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "同じ庭でも、業者によって得意分野や料金体系は異なります。花を咲かせることを前提にした剪定に慣れているか、木ごとに違う時期に合わせて来てくれるか、落ちた花や実の片付けまで受けてくれるかは、業者ごとに差が出やすい点です。時間に余裕があれば2〜3社から見積もりを取り、総額・作業範囲・処分費の扱いを比較するのがおすすめです。金額や説明に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs = [
  {
    q: "西宮で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。花の咲く木を1本だけ、咲かせたい高さに整えたいという依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "剪定してもらったら翌年花が咲きませんでした。なぜですか？",
    a: "切った時期が、翌年の花になる芽ができたあとだった可能性があります。多くの花木は花が終わってしばらくすると翌年に咲く芽を枝に作るため、その後に枝を短く切ると、翌年の花が減ります。次からは「この木は花を見たい」と依頼のときにはっきり伝え、切る時期を花が終わった直後に合わせてもらいましょう。一年花が飛んでも木そのものが弱るわけではないため、翌々年からは戻せることが多いものです。",
  },
  {
    q: "花や実が落ちて掃除が大変です。片付けまで頼めますか？",
    a: "業者によって扱いが異なるため、「切る作業」と「落ちたものの片付け」を分けて伝え、見積もりの段階で範囲を決めましょう。片付けまで含めるか、切った枝だけ持ち帰ってもらうかで総額は変わります。落ちたものが雨どいや排水桝に入ると水の流れが止まるため、屋根と足元の両方を見ておくと安心です。落ちる量そのものを減らしたい場合は、木の入れ替えという選択肢もあります。",
  },
  {
    q: "手の届かない高さで咲くようになりました。低くしてもらえますか？",
    a: "低くすること自体はできますが、一度に強く切り戻すと樹形が崩れ、翌年の花も減ることがあります。「見上げて咲かせる」のか「目の高さで咲かせる」のかを先に決め、目の高さにするなら数年かけて下げる進め方を相談しましょう。高さを抑える剪定は毎年続ける必要があり、止めた年があると翌年に一気に伸びます。脚立の上で腕を上げて切る作業は危険なため、高い位置の作業は自分で行わないでください。",
  },
  {
    q: "同じ場所なのに年々花が減ってきました。肥料を足せばよいですか？",
    a: "肥料の前に、株元と土を見てください。地面が踏み固められていないか、水がたまっていないか、根が地面から浮き出ていないかの三つが手がかりになります。土が締まって水と空気が入らなくなると、木は花より自分を保つほうに力を使います。まわりの木が大きくなって日が当たらなくなっている場合もあります。原因が分からないときは、現地調査で木の状態から見てもらうのが確実です。",
  },
  {
    q: "切った枝や刈った草の処分もお願いできますか？",
    a: "伐採110番は伐採後の木材処分まで一括対応をうたっています。その他の業者でも処分まで含めて対応してもらえることが一般的ですが、処分費が料金に含まれるかどうかはサービス・加盟店により異なるため、見積もり時に必ず確認しましょう。自分で家庭ごみとして出す場合は、お住まいの市区町村のルール（長さ・束ね方・量の制限など）の確認が必要です。落ちた花や実の片付けを含めるかどうかも、あわせて決めておくと総額がぶれません。",
  },
];
...
export default function AreaNishinomiyaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】西宮の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "西宮で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "西宮の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#nishinomiya5",
      label: "1｜西宮で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "西宮の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#hanamejiki", label: "2｜花を見るために植えた木は、切る時期を誤ると翌年咲かない——「花芽がいつできるか」で剪定時期が決まる" },
    { href: "#hanagara", label: "3｜花のあとに落ちるもの——花がら・花びら・実の始末まで含めて頼む範囲を決める" },
    { href: "#sakasetakasa", label: "4｜大きくなった花木は「見上げて咲かせる」か「目の高さで咲かせる」かを決めると手入れが軽くなる" },
    { href: "#kabumoto", label: "5｜花つきが落ちた木は、切り方より先に株元と土を疑う" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜西宮の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">西宮の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「形を整えてもらったら、翌年まったく咲かなくなった」「花が終わったあとの掃除が、咲いている期間より長く感じる」「手の届かない高さで咲くようになり、切ることも見ることもできない」「同じ場所に植えているのに、年々花が減ってきた」——西宮で庭業者を探すきっかけには、花の咲く木を庭に植えている家ならではの、「咲かせ続けるための手入れ」に関わる困りごとが絡むことがあります。
            </p>
            <p>
              本記事では、西宮市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「花を見るために植えた木は花芽がいつできるかで剪定時期が決まること」「花のあとに落ちる花がら・花びら・実の始末まで含めて頼む範囲を決めること」「大きくなった花木は見上げて咲かせるか目の高さで咲かせるかを決めること」「花つきが落ちた木は切り方より先に株元と土を疑うこと」といった、西宮で特に確認しておきたい依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="nishinomiya5" num="1">西宮で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            西宮市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月17日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月17日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、西宮での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="hanamejiki" num="2">花を見るために植えた木は、切る時期を誤ると翌年咲かない——「花芽がいつできるか」で剪定時期が決まる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            花を見るために植えた木で、いちばん多い失敗は<Hl>「形を整えたら、翌年花が咲かなくなった」</Hl>というものです。原因は切り方より切った時期にあります。木は花が終わってしばらくすると、翌年に咲く芽を枝に作ります。その芽ができたあとに枝を短く切れば、翌年の花はなくなります。花の咲く木の手入れの全体像は<Link href="/kaboku-kaika-teire/" className="text-[#2D7F3E] underline">花木の開花と手入れの基本</Link>、時期の考え方は<Link href="/sentei-jiki/" className="text-[#2D7F3E] underline">庭木の剪定時期の基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            覚え方はひとつで足ります。<Hl>「花が終わったら、なるべく早く切る」</Hl>。多くの花木はこの順番に当てはまります。木ごとの細かい違いは<Link href="/ajisai-sentei-kanri/" className="text-[#2D7F3E] underline">アジサイの剪定と管理</Link>、<Link href="/tsubaki-sazanka-teire/" className="text-[#2D7F3E] underline">ツバキ・サザンカの手入れ</Link>、<Link href="/bara-teire-kihon/" className="text-[#2D7F3E] underline">庭のバラの手入れの基本</Link>、<Link href="/kinmokusei-teire/" className="text-[#2D7F3E] underline">キンモクセイの手入れ</Link>、<Link href="/momiji-kaede-teire/" className="text-[#2D7F3E] underline">モミジ・カエデの手入れ</Link>にそれぞれまとめています。実を楽しむ木は花のあとの扱いが変わるため、<Link href="/kaju-niwaki-teire/" className="text-[#2D7F3E] underline">庭の果樹の手入れの基本</Link>も参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            業者に頼むときは、<Hl>「この木は花を見たい」とはっきり伝える</Hl>ことが何より効きます。伝えないまま「全体を整えてください」と頼むと、形を優先した仕上がりになり、翌年の花が減ることがあります。剪定110番は庭木1本からの依頼に対応し、剪定1本2,890円〜（出張費3,000円別途）の掲載料金で、現地調査・見積もりは無料です。くらしのマーケットは予約前に業者とメッセージで相談できるため、花が終わった木の写真を送って切ってよい時期かを聞いてから予約できます。
          </p>

          {/* 3 */}
          <H2 id="hanagara" num="3">花のあとに落ちるもの——花がら・花びら・実の始末まで含めて頼む範囲を決める</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            花の咲く木を植えるとき、多くの人は咲いている姿だけを思い描きます。実際に手間になるのは<Hl>咲いたあと</Hl>です。しおれた花、風で散る花びら、落ちて潰れる実——どれも短い期間に集中して出るため、その時期だけ掃除の回数が跳ね上がります。落ちるものの片付け方は<Link href="/ochiba-taisaku/" className="text-[#2D7F3E] underline">落ち葉対策と掃除の基本</Link>、集めたものの使い道は<Link href="/ochiba-taihi-compost/" className="text-[#2D7F3E] underline">落ち葉堆肥・コンポストの基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            見ておきたいのは<Hl>「どこに落ちるか」</Hl>です。舗装の上なら掃くだけですが、通り道に落ちれば踏まれて汚れになり、雨どいや排水桝に入れば水の流れを止めます。花びらや実が集まりやすいのは、<Hl>建物の壁ぎわ、通路の端、そして雨の水が流れ込む低い場所</Hl>の三つです。排水の点検は<Link href="/haisuimasu-tenken/" className="text-[#2D7F3E] underline">排水桝の点検の基本</Link>、地面の水の抜け方は<Link href="/niwa-mizuhake/" className="text-[#2D7F3E] underline">庭の水はけ改善の考え方</Link>、足元が滑りやすくなる場合は<Link href="/niwa-koke-taisaku/" className="text-[#2D7F3E] underline">庭の苔対策の基本</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            頼むときは、<Hl>「切る作業」と「落ちたものの片付け」を分けて伝える</Hl>と、範囲も金額もはっきりします。片付けまで含めるのか、切った枝だけ持ち帰ってもらうのかで総額は変わります。草刈り110番は1平米600円〜という面積単価のため、花壇の外周や植え込みの足元のように範囲がはっきりした依頼と相性がよく、刈った後の防草シート施工も相談できます。落ちるものの量そのものを減らすかどうかを考えるなら<Link href="/ochiba-sukunai-niwaki/" className="text-[#2D7F3E] underline">落ち葉が少ない庭木の選び方</Link>と<Link href="/teire-raku-niwaki/" className="text-[#2D7F3E] underline">手入れが楽な庭木の選び方</Link>をご覧ください。
          </p>

          {/* 4 */}
          <H2 id="sakasetakasa" num="4">大きくなった花木は「見上げて咲かせる」か「目の高さで咲かせる」かを決めると手入れが軽くなる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            植えたときは目の高さで咲いていた木が、何年かたつと頭の上で咲くようになります。このとき迷わないために決めておきたいのが、<Hl>その木を「見上げて咲かせる」のか「目の高さで咲かせる」のか</Hl>です。決めてしまえば、切る量も、頼む頻度も、脚立が要るかどうかも自動的に決まります。高さを意識した手入れは<Link href="/symboltree-teire/" className="text-[#2D7F3E] underline">シンボルツリーの手入れの基本</Link>、低く保つ木の扱いは<Link href="/teiboku-kanri/" className="text-[#2D7F3E] underline">低木・植え込みの管理の基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            見上げて咲かせるなら、<Hl>下枝を整理して幹を見せ、上で咲かせる</Hl>形になります。花は遠くから見る前提になり、落ちるものの範囲は広がります。目の高さで咲かせるなら、高さを抑える剪定を毎年続ける必要があり、<Hl>止めた年があると、翌年は一気に伸びて元に戻りにくくなります</Hl>。目隠しを兼ねている木は高さを下げると役割が変わるため、<Link href="/mekakushi-niwaki/" className="text-[#2D7F3E] underline">目隠しになる庭木の選び方</Link>と<Link href="/ikegaki-fence-hikaku/" className="text-[#2D7F3E] underline">生垣とフェンスの比較</Link>を先に確認しておきましょう。植える位置から考え直す場合は<Link href="/shokusai-haichi-keikaku/" className="text-[#2D7F3E] underline">植栽の配置計画の立て方</Link>、木を動かす選択肢は<Link href="/niwaki-ishoku/" className="text-[#2D7F3E] underline">庭木の移植の解説記事</Link>が参考になります。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            高くなりすぎた木を自分で切るのは避けてください。<Hl>脚立の上で腕を上げて切る作業は、花木であっても危険は変わりません</Hl>。判断の目安は<Link href="/takagi-sentei-kiken/" className="text-[#2D7F3E] underline">高木剪定の危険と業者に頼む判断</Link>にまとめています。高さを下げる手入れを毎年続けるなら、smileガーデンの定額制の年間管理プランのように回数と時期を決めて任せる方法があり、作業後に写真付きの作業報告書を受け取れます。木そのものを入れ替える判断に傾いたときは、伐採110番が伐採・抜根と伐採後の木材処分まで一括で相談でき、見積もりは無料です。
          </p>

          {/* 5 */}
          <H2 id="kabumoto" num="5">花つきが落ちた木は、切り方より先に株元と土を疑う</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            切る時期も高さも間違えていないのに花が減った——という場合、目を向けたいのは枝ではなく<Hl>株元と土</Hl>です。同じ場所で何年も育つうちに土は締まり、水と空気が入りにくくなります。根が呼吸しづらくなれば、木は花より自分を保つほうに力を使います。土の整え方は<Link href="/kadan-tsuchizukuri/" className="text-[#2D7F3E] underline">花壇の土づくりの基本</Link>、養分の与え方は<Link href="/niwaki-hiryo/" className="text-[#2D7F3E] underline">庭木の肥料の基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            株元で見ておきたいのは三つです。<Hl>地面が踏み固められていないか、水がたまっていないか、根が地面から浮き出ていないか</Hl>。通り道のそばに植えた木は踏まれて締まりやすく、低い場所の木は水が抜けずに傷みます。根が浮き出てきた木は<Link href="/niwaki-neagari-hoso/" className="text-[#2D7F3E] underline">庭木の根上がりと舗装への影響</Link>、水の抜け方は<Link href="/niwa-mizuhake/" className="text-[#2D7F3E] underline">庭の水はけ改善の考え方</Link>、地面を覆って踏み固めを和らげる方法は<Link href="/groundcover-erabikata/" className="text-[#2D7F3E] underline">グランドカバープランツの選び方</Link>を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            それでも戻らない場合は、<Hl>その場所がその木に向かなくなっている</Hl>可能性があります。日が回らなくなった、まわりの木が大きくなって光を取っている、といった変化は年単位で進むため気づきにくいものです。日陰になった場所の植栽は<Link href="/hikage-niwa-shokusai/" className="text-[#2D7F3E] underline">北向き・日陰の庭の植栽の考え方</Link>、鉢との行き来は<Link href="/hachiue-jiue-uekae/" className="text-[#2D7F3E] underline">鉢植えから地植えへの植え替え</Link>、木以外で花を絶やさない方法は<Link href="/shukkonso-ichinenso/" className="text-[#2D7F3E] underline">宿根草と一年草の使い分け</Link>と<Link href="/kyukon-shokubutsu-kanri/" className="text-[#2D7F3E] underline">球根植物の管理の基本</Link>にまとめています。判断に迷うときは、剪定110番の無料の現地調査で木の状態から見てもらうのも手です。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">西宮の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            西宮で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。花の咲く木を1本単位で咲かせたい高さに整えるなら樹種別の目安がある剪定110番、花壇の外周や植え込みの足元の草を範囲を決めて片付けるなら面積単価が分かりやすい草刈り110番、何年も咲かなくなった木を入れ替えるなら処分まで一括の伐採110番、木ごとに違う手入れの時期をまとめて任せるならsmileガーデン、切ってよい時期を写真で相談してから頼むならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            花の咲く木を庭に植えている家では、「形を整えること」ではなく「咲かせ続けること」を目的に据えると、頼む内容が決まります。花芽ができる時期から剪定時期を決めること、花のあとに落ちるものの始末まで含めて範囲を決めること、咲かせる高さを先に決めること、花つきが落ちたら株元と土を疑うこと、そして処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
