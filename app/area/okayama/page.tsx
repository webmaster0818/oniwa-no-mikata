...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】岡山の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "岡山で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・伐採110番・草刈り110番（1平米600円〜）・smileガーデン・くらしのマーケットの料金と特徴、家庭菜園・果樹と庭木を両立させる剪定の考え方、菜園スペースを作るための庭木の整理まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】岡山の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "岡山で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。家庭菜園や果樹の日当たりを確保する庭木の剪定、菜園スペースを作るための伐採・抜根、菜園のそばの雑草対策など、庭で育てる楽しみと手入れを両立したい方が押さえたい注意点も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、岡山市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。菜園スペースを作るための伐採・抜根も、木材の処分まで一度に相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "大きくなりすぎた庭木を根元から処分したい人",
      "菜園スペースを作るために木を抜根したい人",
      "伐採した木材の処分まで一括で頼みたい人",
      "抜根して庭を作り替えたい人",
    ],
    table: [
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        を使えば、菜園の世話に集中したい時期の雑草管理を任せきりにできます。
      </>
    ),
    recommend: [
      "庭や空き地の雑草を低価格で片付けたい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。菜園と両立させたい庭木の手入れを季節ごとの仕組みにする使い方にも向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    recommend: [
      ...
      "庭木の剪定・消毒・施肥を季節ごとの仕組みにしたい人",
      "菜園の世話に時間を使い、庭木の管理は任せたい人",
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。岡山市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、菜園の位置や日当たりの様子を写真で伝えながら依頼内容を固めるといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 「育てている場所」を含めて庭の状況を伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、庭で野菜や果樹を育てている場合は、菜園・花壇の位置と「ここは触らないでほしい」という場所を最初に伝えることが大切です。作業の動線や刈り草・薬剤の扱いにも関わるためです。庭全体と菜園まわりをスマートフォンで撮影し、大切に育てている場所に印を付けて共有すると、見積もりの精度が上がります。",
  },
  {
  ...
  {
    t: "③ 薬剤散布の有無と範囲を事前にすり合わせる",
    b: "庭木の消毒や除草剤の散布を含む作業では、近くで食べるものを育てているかどうかで対応が変わり得ます。菜園や果樹のそばでの薬剤使用を避けたい場合は、その旨を見積もり時にはっきり伝え、手刈り・機械刈りへの切り替えや散布範囲の調整ができるかを確認しましょう。事前のすり合わせが、作業後の「こんなはずでは」を防ぎます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "岡山で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。菜園の日当たりをふさいでいる木を1本だけ整えたいという依頼でも相談できます。最低価格は樹種・高さにより変わるため、出張費を含めた総額を見積もりで確認しましょう。",
  },
  {
    q: "家庭菜園の日当たりが悪くなってきました。庭木の剪定で改善できますか？",
    a: "改善できる場合があります。菜園に影を落としている庭木の高さを下げる、枝を透かして光と風が通るようにするといった剪定で、日当たり・風通しが変わることがあります。どの枝をどこまで切れるかは樹種や木の状態によるため、剪定110番のような現地調査無料のサービスで「菜園の日当たりを良くしたい」という目的を伝えて相談するのがおすすめです。",
  },
  {
    q: "庭の一角を菜園にしたいのですが、木の伐採・抜根から頼めますか？",
    a: "頼めます。伐採110番は伐採・抜根の専門サービスで、木材の処分まで一括で相談できます。切り株や根が残っていると耕したり畝を作ったりする際の妨げになるため、菜園にする予定の場所は伐採だけでなく抜根まで行うかを見積もり時に相談しましょう。伐採と抜根の違いは当サイトの解説記事でもまとめています。",
  },
  {
    q: "柿や梅などの果樹の剪定も庭業者に頼めますか？",
    a: "相談できます。剪定110番などの庭木の剪定サービスでは果樹の剪定も依頼の対象になりますが、対応範囲や得意分野は業者・加盟店により異なるため、樹種を伝えて対応可否を確認しましょう。実付きを重視した剪定を希望する場合は、その目的も最初に伝えておくと、仕上がりのすれ違いを防げます。",
  },
  {
    q: "菜園の近くで除草剤を使いたくないのですが、雑草対策はできますか？",
    a: "できます。除草剤を使わず、手刈り・機械刈りによる草刈りや、防草シートと砂利による物理的な対策を組み合わせる方法があります。草刈り110番は草刈りと防草シート施工の両方に対応しているため、見積もり時に「菜園の近くでは薬剤を使いたくない」と伝えたうえで、場所ごとの対策を相談しましょう。",
  },
  {
...
export default function AreaOkayamaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】岡山の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "岡山で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "岡山の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#okayama5",
      label: "1｜岡山で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "岡山の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#hiatari", label: "2｜家庭菜園・果樹と庭木は「日当たりと風通し」の取り合いになる" },
    { href: "#saien", label: "3｜菜園スペースを作るなら伐採・抜根から仕上げまで一括で" },
    { href: "#kaju", label: "4｜果樹の手入れと庭木の剪定はまとめて相談できる" },
    { href: "#zasso", label: "5｜菜園のそばの雑草対策は「育てる場所」と「抑える場所」を分ける" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜岡山の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">岡山の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「庭木が茂って、家庭菜園の日当たりが悪くなってきた」「庭の一角を菜園にしたいのに、木と切り株が邪魔をしている」——庭で野菜や果樹を育てる楽しみが根付いている岡山では、庭業者への相談にも「育てるスペースと庭木の両立」がよく関わってきます。庭木と菜園は同じ庭の中で日当たり・風通し・スペースを分け合う関係にあり、どちらかが茂りすぎればどちらかが割を食います。庭木の手入れを「木のためだけの作業」ではなく「庭全体の使い方を整える作業」と捉えると、頼み方が見えてきます。
            </p>
            <p>
              本記事では、岡山市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「菜園の日当たりを確保する剪定の考え方」「菜園スペースを作るための伐採・抜根の頼み方」「菜園のそばの雑草対策の使い分け」といった、育てる庭ならではの依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="okayama5" num="1">岡山で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            岡山市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年8月13日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年8月13日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、岡山での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2｜日当たり */}
          <H2 id="hiatari" num="2">家庭菜園・果樹と庭木は「日当たりと風通し」の取り合いになる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            同じ庭の中で、庭木と菜園は日当たり・風通し・スペースを分け合っています。庭木が茂りすぎると、<Hl>菜園や果樹に影がかかって日照が不足し、風通しの悪さは蒸れの原因になります</Hl>。「野菜の育ちが年々悪くなってきた」と感じるとき、原因が土や品種ではなく、大きくなった庭木の影ということもあります。庭木側の高さを下げる、影を落とす方向の枝を整理する、枝を透かして光と風を通すといった剪定で、育てる場所の環境は変えられます。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            風通しの改善は、病害虫の面でも意味があります。枝葉が込み合って湿気がこもった庭木は病害虫が発生しやすく、<Hl>庭木に付いた虫や病気が、すぐそばの菜園や果樹に広がる</Hl>こともあります。庭木の病害虫のサインと対処は
            <Link href="/niwaki-byogaichu/" className="text-[#2D7F3E] underline">庭木の病害虫の解説記事</Link>
            でまとめています。剪定110番なら、剪定とあわせて消毒の相談もでき、現地調査・見積もりは無料です。「菜園の日当たりを良くしたい」という目的をはっきり伝えて相談しましょう。
          </p>

          {/* 3｜菜園スペース */}
          <H2 id="saien" num="3">菜園スペースを作るなら伐採・抜根から仕上げまで一括で</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭の一角を菜園に作り替える場合、木を切るだけでは終わりません。<Hl>切り株や根が残った場所は耕せず、畝も作れない</Hl>ため、菜園にする範囲は伐採に加えて抜根まで必要になるのが一般的です。伐採と抜根は作業の内容も費用も別物なので、違いを知っておくと見積もりの理解が早くなります。詳しくは
            <Link href="/bassai-bakkon-chigai/" className="text-[#2D7F3E] underline">伐採と抜根の違いの解説記事</Link>
            を参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            伐採110番は伐採・抜根の専門サービスで、<Hl>切った木材の処分まで一括で相談できる</Hl>のが強みです。菜園づくりでは「どこまでを業者に頼み、どこからを自分でやるか」の線引きも大切で、抜根後の整地まで頼むのか、土づくりは自分で楽しむのかを決めてから見積もりを取ると、費用の比較がしやすくなります。くらしのマーケットなら、伐採・抜根や整地を扱う地域の出店者を料金と口コミで比較し、予約前にメッセージで計画を伝えて相談できます。
          </p>

          {/* 4｜果樹 */}
          <H2 id="kaju" num="4">果樹の手入れと庭木の剪定はまとめて相談できる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            柿・梅・柑橘類など、庭で果樹を育てている家では、「果樹の剪定は庭業者に頼めるのか」という疑問がよく出ます。結論としては相談できますが、<Hl>果樹の剪定は、樹形を整える一般の庭木剪定と目的が異なる</Hl>点は知っておきましょう。実を付けさせたいのか、大きさを抑えたいのか、目的によって切り方の方針が変わるため、依頼時に「収穫を楽しみたい」「とにかく小さくしたい」といった希望をはっきり伝えることが大切です。剪定の適期も樹種ごとに異なるため、
            <Link href="/sentei-jiki/" className="text-[#2D7F3E] underline">剪定時期の解説記事</Link>
            もあわせて参考にしてください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            果樹と庭木の両方がある庭では、smileガーデンの<Hl>定額制の年間管理プラン</Hl>のように、剪定・消毒・施肥をセットで季節ごとに任せられるサービスも選択肢になります。手入れの時期がばらばらな木々を一つの計画にまとめられるのが利点です。果樹への対応内容やプランの範囲は加盟店によって異なるため、無料の見積もり時に庭の構成を伝えて確認しましょう。
          </p>

          {/* 5｜雑草対策 */}
          <H2 id="zasso" num="5">菜園のそばの雑草対策は「育てる場所」と「抑える場所」を分ける</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            菜園のある庭の雑草対策で悩ましいのが、除草剤の扱いです。食べるものを育てている場所の近くでは薬剤を使いたくない、と考える人は少なくありません。おすすめしたいのは、<Hl>庭を「育てる場所」と「雑草を抑える場所」に分けて、場所ごとに対策を変える</Hl>考え方です。菜園とそのまわりは手刈り・機械刈りで管理し、通路や庭の外周など育てる予定のない場所は防草シートや砂利で覆って、雑草が生える面積そのものを減らします。雑草対策の全体像は
            <Link href="/zasso-taisaku/" className="text-[#2D7F3E] underline">雑草対策の解説記事</Link>
            でまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            草刈り110番は<Hl>1平米600円〜の草刈りに加えて、防草シート施工にも対応</Hl>しているため、「今の雑草を片付ける」と「生えにくくする」を場所ごとに組み合わせて相談できます。薬剤を使いたくない場所がある場合は、見積もり時にその旨をはっきり伝えましょう。定期メンテナンスプランを使えば、菜園の世話が忙しい時期の雑草管理だけを任せるという分担もできます。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">岡山の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            岡山で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。菜園の日当たりを確保する剪定なら庭木1本から頼める剪定110番、菜園スペースを作る伐採・抜根なら処分まで一括の伐採110番、菜園以外の場所の雑草管理なら防草シート施工まで頼める草刈り110番、果樹と庭木の手入れを季節ごとの仕組みにするならsmileガーデン、地域の業者を口コミで比較して選ぶならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            育てる楽しみのある庭は、庭木の手入れしだいでもっと使いやすくなります。菜園・果樹の位置と「触らないでほしい場所」を最初に伝えること、薬剤散布の有無と範囲を事前にすり合わせること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の使い方に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwaki-byogaichu/", label: "庭木の病害虫対策" },
