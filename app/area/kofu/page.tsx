...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】甲府の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較｜お庭のミカタ",
  },
  description:
    "甲府で剪定・伐採・草刈りを頼める庭業者を比較。剪定110番（1本2,890円〜）・草刈り110番（1平米600円〜）・伐採110番・smileガーデン・くらしのマーケットの料金と特徴、防犯の視点で庭の死角を減らす考え方、足元と明かりの備えまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】甲府の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "甲府で剪定・伐採・草刈りを頼める庭業者5社を料金・特徴で比較。防犯の視点で庭を見直す手順、窓まわりと家の裏手にできる死角、足元の砂利と明かりの使い方、塀・生垣・フェンスの高さで変わる意味も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const companies: AreaCompany[] = [
  {
    ...
    intro: (
      <>
        ...
        から依頼者の近くのプロを手配する仕組みで、甲府市内の依頼でも近隣の加盟店が対応します。
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        ため、家のまわりや裏手など、片付けたい範囲を決めて頼みやすいサービスです。刈った後の
        <Hl>防草シート施工や除草剤散布</Hl>
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        のが特徴です。剪定では扱いきれないほど大きくなり、家の周囲をふさいでしまった木の整理もまとめて相談できます。24時間受付で、見積もりは無料です。
      </>
    ),
    recommend: [
      "家の周囲をふさぐほど育った木を整理したい人",
  ...
  },
  {
    ...
    intro: (
      <>
        ...
        で剪定・消毒・施肥をセットで任せられます。生垣のように定期的な刈り込みが前提の庭では、回数と時期を決めて任せる形が向いています。作業後には
        <Hl>写真付きの作業報告書</Hl>
    ...
    memo:
      "定額制の年間管理プラン・写真付き作業報告書・見積もり出張無料と、年間3万件・満足度4.1という公式掲載の実績値を当サイトのレビュー記事作成時に確認しています。フランチャイズ型のため、実際の対応は地域の加盟店によります。甲府市内の対応可否とプラン内容は見積もり時に確認してください。",
  },
  {
    ...
    intro: (
      <>
        ...
        され、予約前に業者とメッセージで相談できるため、作業してほしい範囲を伝えたうえで予約するといった使い方もしやすい仕組みです。
        <Hl>トラブル時の費用補償制度</Hl>
        も用意されています。
      </>
    ),
...
const steps = [
  {
    t: "① 気になっている場所を、外から撮った写真で伝える",
    b: "「剪定」「伐採」「草刈り」のどれを頼みたいのかに加えて、見通しを良くしたいのはどこかを具体的に伝えましょう。道路側や隣地側から自宅を撮った写真があると、どこが死角になっているのかが伝わりやすく、切る量の相談もしやすくなります。見積もりの精度も上がります。",
  },
  {
  ...
  {
    t: "③ 資格が関わる工事かどうかを切り分ける",
    b: "庭の中の作業でも、屋外コンセントの増設など電源にかかわる工事は電気工事士の資格が必要な領域です。庭業者に頼める範囲と、専門の工事業者に頼む範囲を最初に切り分けておくと、話が二度手間になりません。照明を検討している場合は、設置方式によって必要な工事が変わることも押さえておきましょう。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  {
    q: "甲府で庭木1本だけの剪定でも頼めますか？",
    a: "頼めます。剪定110番は庭木1本からの依頼に対応しており、剪定1本2,890円〜（出張費3,000円別途）です。窓の前の木を透かして見通しを確保したい、といった依頼もできます。樹種や高さによって手間が変わるため、最低価格ではなく出張費を含めた総額を見積もりで確認しましょう。現地調査・見積もりは無料です。",
  },
  {
    q: "防犯のために庭木は切ってしまったほうがよいですか？",
    a: "必ずしも切る必要はありません。木を減らさなくても、枝を透かして光と視線が通るようにすれば見通しは変わります。木は日よけや目隠しの役割も担っているため、全部を切ると別の不便が生じることもあります。どこを見えるようにして、どこを隠したいのかを分けて考えるのがおすすめです。",
  },
  {
    q: "防犯砂利はどこに敷けばよいですか？",
    a: "通り道になりやすい場所、たとえば窓の下や家の裏手の通路など、人が歩く可能性のある場所に敷くのが一般的な考え方です。素材や粒の大きさ、敷く厚みによって音の出方が変わり、量が足りないと効果が薄くなります。当サイトの防犯砂利の選び方の記事に、選定の基準をまとめています。",
  },
  {
    q: "庭に照明を付けたいのですが、自分で設置できますか？",
    a: "設置できる範囲は電源の方式によって変わります。配線工事のいらない方式であれば自分で設置できますが、屋外コンセントの増設や器具を電源に直接つなぐ工事は電気工事士の資格が必要な領域です。当サイトのガーデンライトと配線の注意点の記事で、切り分けを確認してから検討してください。",
  },
  {
    q: "生垣とフェンスはどちらが防犯に向いていますか？",
    a: "一概には言えません。生垣は景観と目隠しを兼ねられますが、刈り込みを続けないと厚みが増して見通しが悪くなります。フェンスは日常の手入れが少ない一方、設置費用がかかり劣化すれば交換が必要です。高さによっても意味が変わるため、その場所に見通しを求めるのか、囲いを求めるのかで判断してください。",
  },
  {
...
export default function AreaKofuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】甲府の庭業者おすすめ5選！剪定・伐採・草刈りの料金を徹底比較",
    description:
      "甲府で剪定・伐採・草刈りを頼める庭業者5社を、料金・特徴で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "甲府の庭業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kofu5",
      label: "1｜甲府で頼れるおすすめの庭業者5選",
      sub: [
        { href: "#hikaku", label: "甲府の庭業者を一覧表で徹底比較" },
        ...companies.map((c) => ({ href: `#${c.slug}`, label: `${c.num}｜【${c.catch}】${c.name}` })),
      ],
    },
    { href: "#sec2", label: "2｜防犯の視点で庭を見ると、直すべき場所が変わる" },
    { href: "#sec3", label: "3｜窓まわりと家の裏手は、植栽で死角になりやすい" },
    { href: "#sec4", label: "4｜足元の音と明かりは、庭でできる備えの定番" },
    { href: "#sec5", label: "5｜塀・生垣・フェンスは「高さ」で意味が変わる" },
    { href: "#erabikata", label: "6｜失敗しない庭業者の選び方4ステップ" },
    { href: "#faq", label: "7｜甲府の庭業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-[#6b7563] mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-[#33402f]">甲府の庭業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-[#4a5443]">
            <p className="mb-4">
              「庭木が茂って家の裏側が見えなくなっている」「夜になると庭が真っ暗で気になる」——甲府で庭業者を探すきっかけとして、防犯の不安が挙がることがあります。庭は日当たりや見た目で考えることが多い場所ですが、視点を変えると、家の外周の安全にも関わっています。
            </p>
            <p>
              本記事では、甲府市内から依頼できる主要な庭業者を、当サイト編集部が各社レビュー記事の作成時に調査した料金・サービス内容で比較しました。あわせて、「防犯の視点で庭を見ると直すべき場所が変わること」「窓まわりと家の裏手にできる死角」「足元の砂利と明かりの使い方」「塀・生垣・フェンスは高さで意味が変わること」といった、庭の外周を見直すための依頼の考え方もまとめています。ぜひ業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kofu5" num="1">甲府で頼れるおすすめの庭業者5選</H2>
          <p className="leading-loose mb-2 text-[#4a5443]">
            甲府市内から依頼できる主要な庭業者5社を紹介します。掲載している料金・サービス内容は、当サイト編集部が各社のレビュー記事作成時に公式サイト等を調査した掲載値です（2026年9月2日時点の掲載内容）。実際の総額は樹種・本数・庭の状況で変わるため、必ず作業前に見積もりで確認してください。なお、お庭マスターは関東エリア中心のサービスのため、本ページのカード紹介からは除外し、比較表のみに掲載しています。
          </p>
          ...
          <p className="text-xs text-[#6b7563] mb-10">
            ※料金は当サイト各社レビュー記事の調査時掲載値（最低価格・相場の目安）です。2026年9月2日時点の掲載内容であり、樹種・本数・面積・庭の状況により総額は変動します。お庭マスターは関東エリア中心のサービスのため、甲府での対応可否は公式サイト・見積もり時にご確認ください。最新の料金は各社公式サイト・見積もりでご確認ください。
          </p>
          ...
          {/* 2 */}
          <H2 id="sec2" num="2">防犯の視点で庭を見ると、直すべき場所が変わる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭の手入れは、見た目や植物の健康を基準に考えることが多いものですが、<Hl>外から見えるかどうかという基準で見直すと、優先順位が変わります</Hl>。伸びた枝や茂った植え込みは、道路や近隣からの視線を遮ります。それは目隠しとして望ましい場合もありますが、同時に、敷地の中で人が身を隠せる場所を作ることにもなります。防犯の考え方の全体像は<Link href="/niwa-bohan/" className="text-[#2D7F3E] underline">庭の防犯対策の基本</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            大切なのは、<Hl>隠したい場所と、見えるようにしておきたい場所を分けること</Hl>です。庭でくつろぐ空間は視線を遮りたい一方、出入り口や窓のまわりは見通しを確保しておきたい場所です。目隠しに使う木の性質は<Link href="/mekakushi-niwaki/" className="text-[#2D7F3E] underline">目隠しになる庭木の選び方</Link>を参考にしてください。庭全体の使い分けを考えるときは<Link href="/niwa-sekkeizu-mikata/" className="text-[#2D7F3E] underline">庭の設計図・平面図の読み方</Link>も役に立ちます。
          </p>

          <H2 id="sec3" num="3">窓まわりと家の裏手は、植栽で死角になりやすい</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            実際に外を歩いて自宅を眺めてみると、<Hl>普段は意識しない場所が見えなくなっていることに気づきます</Hl>。とくに、窓の前に植えた木が大きくなって窓ごと隠れている、家の裏手や物置のまわりが植え込みで囲まれている、といった状態は、内側からも外側からも様子が分かりにくくなります。あわせて、その場所に雑草が伸びていないか、物が置きっぱなしになっていないかも確認しましょう。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            手を入れる方法は、切る量ではなく<Hl>透かして光と視線を通すこと</Hl>が基本です。木そのものを減らさなくても、枝を間引けば見通しは変わります。剪定110番は庭木1本から依頼でき、剪定1本2,890円〜（出張費3,000円別途）の掲載料金で、現地調査・見積もりは無料です。足元の草が伸びている場合は、草刈り110番の1平米600円〜という面積単価で範囲を決めて頼む方法もあります。物置まわりの片付けと合わせて考えるなら<Link href="/zasso-haenikui-niwa/" className="text-[#2D7F3E] underline">雑草が生えにくい庭のつくり方</Link>も参考になります。
          </p>

          <H2 id="sec4" num="4">足元の音と明かりは、庭でできる備えの定番</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            庭でできる備えとして知られているのが、足元の素材と明かりです。踏むと音が出る<Hl>防犯砂利</Hl>は、通り道になりやすい場所に敷くことで気づきやすくする狙いがあります。素材や粒の大きさ、敷く量によって効果の出方が変わるため、選び方は<Link href="/bohan-jari-erabikata/" className="text-[#2D7F3E] underline">防犯砂利の選び方</Link>にまとめています。敷き方の基本は<Link href="/jarishiki/" className="text-[#2D7F3E] underline">庭の砂利敷きの基礎知識</Link>もあわせてご覧ください。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            明かりについては、<Hl>どこを何のために照らすかを先に決める</Hl>と無駄がありません。全体を明るくするのではなく、出入り口、通路、暗くなりやすい裏手といった場所を狙って照らす考え方です。計画の立て方は<Link href="/niwa-shomei-keikaku/" className="text-[#2D7F3E] underline">庭の照明計画の立て方</Link>にまとめています。なお、<Hl>屋外の電源工事は資格が関わる領域</Hl>で、自分で設置できる範囲とそうでない範囲があります。切り分けは<Link href="/garden-light-chui/" className="text-[#2D7F3E] underline">ガーデンライトと配線の注意点</Link>を必ず確認してください。
          </p>

          <H2 id="sec5" num="5">塀・生垣・フェンスは「高さ」で意味が変わる</H2>
          <p className="leading-loose mb-4 text-[#4a5443]">
            外周を囲うものは、高くすれば安心というわけではありません。<Hl>高い塀や密な生垣は外からの視線を遮る一方、敷地の中で起きていることも見えなくします</Hl>。低めに保って見通しを確保する考え方と、しっかり囲って入りにくくする考え方があり、その場所に何を求めるかで選び方が変わります。生垣とフェンスの違いは<Link href="/ikegaki-fence-hikaku/" className="text-[#2D7F3E] underline">生垣とフェンスの比較</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4 text-[#4a5443]">
            生垣を選ぶ場合は、<Hl>刈り込みを続けることが前提</Hl>になります。手入れが止まると枝が伸びて厚みが増し、かえって見通しが悪くなります。刈り込みの時期と頻度は<Link href="/ikegaki-karikomi/" className="text-[#2D7F3E] underline">生垣の刈り込みの基礎知識</Link>をご覧ください。定期的に整える形にするなら、smileガーデンの定額制の年間管理プランのように回数を決めて任せる方法があります。塀の所有関係や境界の確認が必要な場合は<Link href="/shikichi-kyokai-hei/" className="text-[#2D7F3E] underline">敷地境界と塀の基礎知識</Link>も参考にしてください。
          </p>
          ...
          {/* 7｜FAQ */}
          <H2 id="faq" num="7">甲府の庭業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4 text-[#4a5443]">
            甲府で剪定・伐採・草刈りを頼める主要な庭業者を比較しました。枝を透かして見通しを確保するなら樹種別の目安がある剪定110番、足元の草を範囲を決めて片付けるなら面積単価が分かりやすい草刈り110番、大きくなりすぎた木の整理なら処分まで一括の伐採110番、生垣などを定期的に整えるならsmileガーデン、作業単位で口コミと料金を見比べるならくらしのマーケット、というように、目的によって向いているサービスは変わります。大手直営の安心感を重視する方はダスキンも選択肢です。
          </p>
          <p className="leading-loose mb-8 text-[#4a5443]">
            防犯の視点で庭を見ると、手を入れるべき場所の順番が変わります。隠したい場所と見えるようにしたい場所を分けること、窓まわりと裏手の死角は枝を透かして解消すること、足元と明かりは狙いを決めて備えること、電源にかかわる工事は資格の範囲を確認すること、処分費・出張費を含めた総額を作業前に確認することが、失敗しないための共通ルールです。本記事の比較を出発点に、庭の状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/niwa-bohan/", label: "庭の防犯対策の基本" },
                { href: "/bohan-jari-erabikata/", label: "防犯砂利の選び方" },
                { href: "/garden-light-chui/", label: "ガーデンライトと配線の注意点" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
